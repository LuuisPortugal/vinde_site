!function () {
    ...
    !function (r) {
        ...
        function o(e, t) {
            var n, r, i, o, s, a, l, c, u, d, h, p = t && t.split("/"), f = y.map, g = f && f["*"] || {};
            if (e && "." === e.charAt(0))if (t) {
                for (p = p.slice(0, p.length - 1), e = e.split("/"), s = e.length - 1, y.nodeIdCompat && b.test(e[s]) && (e[s] = e[s].replace(b, "")), e = p.concat(e), u = 0; u < e.length; u += 1)if (h = e[u], "." === h)e.splice(u, 1), u -= 1; else if (".." === h) {
            ...
            if ((p || g) && f) {
                for (n = e.split("/"), u = n.length; u > 0; u -= 1) {
                    if (r = n.slice(0, u).join("/"), p)for (d = p.length; d > 0; d -= 1)if (i = f[p.slice(0, d).join("/")], i && (i = i[r])) {
                        o = i, a = u;
                        break
                    }
                    if (o)break;
        ...
        var h, p, f, g, m = {}, v = {}, y = {}, w = {}, _ = Object.prototype.hasOwnProperty, $ = [].slice, b = /\.js$/;
        f = function (e, t) {
            var n, r = u(e), i = r[0];
            ...
            var a, u, d, h, p, y, _ = [], $ = typeof n;
            if (o = o || e, "undefined" === $ || "function" === $) {
                for (t = !t.length && n.length ? ["require", "exports", "module"] : t, p = 0; p < t.length; p += 1)if (h = f(t[p], o), u = h.f, "require" === u)_[p] = g.require(e); else if ("exports" === u)_[p] = g.exports(e), y = !0; else if ("module" === u)a = _[p] = g.module(e); else if (i(m, u) || i(v, u) || i(w, u))_[p] = c(u); else {
            ...
            return t = t || function () {
                }, "function" == typeof n && (n = i, i = o), i ? h(r, e, t, n) : setTimeout(function () {
                h(r, e, t, n)
            }, 4), p
        }, p.config = function (e) {
            return p(e)
        ...
        t.Extend = function (e, t) {
            ...
            function r() {
                var e = Array.prototype.unshift, r = n.prototype.constructor.length, i = t.prototype.constructor;
        ...
        return n.prototype.on = function (e, t) {
            ...
            var n = $(t), r = t.style.overflowX, i = t.style.overflowY;
        ...
        return t.Extend(n, t.Observable), n.prototype.render = function () {
            ...
            var n = e('<li role="treeitem" class="select2-results__option"></li>'), r = this.options.get("translations").get(t.message);
            ...
            this.data.current(function (n) {
                ...
                i.each(function () {
                    var t = e(this), n = e.data(this, "data");
            ...
            this.$results.attr("id", r), t.on("results:all", function (e) {
                ...
                if (0 !== e.length) {
                    var t = e.data("data");
                    "true" == e.attr("aria-selected") ? n.options.get("multiple") ? n.trigger("unselect", {data: t}) : n.trigger("close") : n.trigger("select", {data: t})
                }
            }), t.on("results:previous", function () {
                var e = n.getHighlightedResults(), t = n.$results.find("[aria-selected]"), r = t.index(e);
                if (0 !== r) {
                    var i = r - 1;
                    0 === e.length && (i = 0);
                    var o = t.eq(i);
                ...
                var e = n.getHighlightedResults(), t = n.$results.find("[aria-selected]"), r = t.index(e), i = r + 1;
                if (!(i >= t.length)) {
                    var o = t.eq(i);
                    o.trigger("mouseenter");
                ...
                var t = n.$results.scrollTop(), r = n.$results.get(0).scrollHeight - n.$results.scrollTop() + e.deltaY, i = e.deltaY > 0 && t - e.deltaY <= 0, o = e.deltaY < 0 && r <= n.$results.height();
                ...
                var r = e(this), i = r.data("data");
                return "true" === r.attr("aria-selected") ? void(n.options.get("multiple") ? n.trigger("unselect", {
                    originalEvent: t,
                    data: i
                }) : n.trigger("close")) : void n.trigger("select", {originalEvent: t, data: i})
            ...
            var n = this.options.get("templateResult"), r = n(e);
        ...
        return t.Extend(r, t.Observable), r.prototype.render = function () {
            var t = e('<span class="select2-selection" tabindex="0" role="combobox" aria-autocomplete="list" aria-haspopup="true" aria-expanded="false"></span>');
            return t.attr("title", this.$element.attr("title")), this.$selection = t, t
        }, r.prototype.bind = function (e) {
            var t = this, r = (e.id + "-container", e.id + "-results");
        ...
        return n.Extend(r, t), r.prototype.render = function () {
            ...
            r.__super__.bind.apply(this, arguments), this.$selection.on("click", function (e) {
                ...
                var r = e(this), i = r.parent(), o = i.data("data");
                t.trigger("unselect", {originalEvent: n, data: o})
            })
        }, r.prototype.clear = function () {
            this.$selection.find(".select2-selection__rendered").empty()
        }, r.prototype.display = function (e) {
            ...
            if (this.clear(), 0 !== e.length) {
                for (var t = [], n = 0; n < e.length; n++) {
                    var r = e[n], i = this.display(r), o = this.selectionContainer();
        ...
        return t.Extend(r, e), r.prototype.select = function (e) {
            ...
            for (var r = this, i = this.$element.find("option"), o = i.map(function () {
                ...
                if (o.indexOf(l.id) >= 0) {
                    var c = i.filter(t(l)), u = this.item(c), d = (n.extend(!0, {}, u, l), this.option(u));
                    c.replaceWith(d)
                } else {
                    var h = this.option(l);
                    if (l.children) {
        ...
        return t.prototype.query = function (e, t, n) {
            function r(e, o) {
                for (var s = e.results, a = 0; a < s.length; a++) {
                    var l = s[a], c = null != l.children && !r({results: l.children}, !0), u = l.text === t.term;
        ...
        return t.prototype.bind = function (e, t, n) {
            ...
            for (var o = r.get("tokenSeparators") || [], s = n.term, a = 0, l = this.createTag || function (e) {
                ...
                var c = s[a];
                if (-1 !== o.indexOf(c)) {
                    var u = s.substr(0, a), d = e.extend({}, n, {term: u}), h = l(d);
        ...
        return e.prototype.query = function (e, t, n) {
            return t.term = t.term || "", this.maximumInputLength > 0 && t.term.length > this.maximumInputLength ? void this.trigger("results:message", {
                ...
                args: {minimum: this.maximumInputLength, input: t.term, params: t}
            }) : void e.call(this, t, n)
        }, e
        ...
        return t.prototype.render = function (t) {
            var n = t.call(this), r = e('<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="search" tabindex="-1" role="textbox" /></span>');
        ...
        return n.prototype.bind = function (e, t, n) {
            ...
            var r = this, i = "scroll.select2." + n.id, o = "resize.select2." + n.id, s = "orientationchange.select2." + n.id;
            ...
            var r = "scroll.select2." + n.id, i = "resize.select2." + n.id, o = "orientationchange.select2." + n.id;
        ...
        C.prototype.apply = function (d) {
            ...
            if (null == d.selectionAdapter && (d.selectionAdapter = d.multiple ? i : r, null != d.placeholder && (d.selectionAdapter = c.Decorate(d.selectionAdapter, o), d.allowClear && (d.selectionAdapter = c.Decorate(d.selectionAdapter, s))), d.multiple && (d.selectionAdapter = c.Decorate(d.selectionAdapter, a)), d.selectionAdapter = c.Decorate(d.selectionAdapter, l)), "string" == typeof d.language)if (d.language.indexOf("-") > 0) {
                var T = d.language.split("-"), q = T[0];
        ...
        return n.Extend(o, n.Observable), o.prototype._generateId = function (e) {
            ...
            if (e in r) {
                var i = r[e], s = {prevented: !1, name: e, args: t};
        ...
        function t(t) {
            var s = t || window.event, a = l.call(arguments, 1), c = 0, d = 0, h = 0, p = 0, f = 0, g = 0;
        ...
        var i, o, s = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"], a = "onwheel"in document || document.documentMode >= 9 ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"], l = Array.prototype.slice;
        ...
        return null == e.fn.select2 && (e.fn.select2 = function (t) {
            ...
            if ("string" == typeof t) {
                var r = this.data("select2"), i = Array.prototype.slice.call(arguments, 1);
                return r[t](i)
            }
