...
!function (a) {
    ...
    k.prototype = {
        constructor: k, _resolveViewName: function (b) {
            ...
            if (!isNaN(g) && !isNaN(h)) {
                ...
                var B = q[this.o.language].monthsTitle || q.en.monthsTitle || "Months", C = this.picker.find(".datepicker-months").find(".datepicker-switch").text(this.o.maxViewMode < 2 ? B : g).end().find("tbody span").removeClass("active");
    ...
    var q = a.fn.datepicker.dates = {
        ...
        parseDate: function (e, f, g, h) {
            ...
            function j() {
                var a = this.slice(0, l[o].length), b = l[o].slice(0, a.length);
            ...
            var l, m, n, o, p, s = {d: "moveDay", m: "moveMonth", w: "moveWeek", y: "moveYear"}, t = {
                yesterday: "-1d",
                today: "+0d",
                tomorrow: "+1d"
            };
            ...
            var u, v, w = {}, x = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], y = {
                yyyy: function (a, b) {
