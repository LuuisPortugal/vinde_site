...
(function (b) {
    ...
    b.extend(!0, f.defaults, {
        dom: "<'row'<'col-xs-12 col-sm-6'l><'col-xs-12 col-sm-6'f>><'row'<'col-xs-12 col-sm-12'tr>><'row'<'col-xs-12 col-sm-5'i><'col-xs-12 col-sm-7'p>>",
        renderer: "bootstrap"
    });
...
(function (e) {
    ...
    }) : "object" === typeof exports ? module.exports = function (j, i) {
        j || (j = window);
        if (!i || !i.fn.dataTable)i = require("datatables.net")(j, i).$;
        return e(i, j, j.document)
    } : e(jQuery, window, document)
})(function (e, j, i, q) {
    var l = e.fn.dataTable, o = 0, m = function (b, c) {
    ...
    e.extend(m.prototype, {
        _constructor: function () {
            var b = this, c = this.s.dt, a = e("div.dataTables_scrollBody", this.s.dt.table().container());
        ...
        _attach: function (b) {
            var c = this.s.dt, a = c.cell(b).index(), d = this.dom.handle, h = this.s.handle, f = e("div.dataTables_scrollBody", this.s.dt.table().container()), g = 0, k = 0;
            if (!a || -1 === c.columns(this.c.columns).indexes().indexOf(a.column))this._detach(); else {
                this.dom.offsetParent || (this.dom.offsetParent = e(b).offsetParent());
                if (!h.height || !h.width)d.appendTo("body"), h.height = d.outerHeight(), h.width = d.outerWidth();
                a = e(b).position();
                f.length && this.dom.offsetParent[0] !== c.table().node() && (k = f.scrollTop(), g = f.scrollLeft());
            ...
            var c = this, a = this.s.dt, d = m.actions, h = [];
            ...
            if (1 === h.length && !1 === this.c.alwaysAsk) {
                ...
                e.each(h, function (h, f) {
                    g.append(e("<li/>").append('<div class="dt-autofill-question">' + d[f].option(a,
                            b) + "<div>").append(e('<div class="dt-autofill-button">').append(e('<button class="' + m.classes.btn + '">' + a.i18n("autoFill.button", "&gt;") + "</button>").on("click", function () {
            ...
            var c =
                this.s.dt, a = this.s.start, d = e(this.dom.start), h = e(b), f = {
                row: c.rows({page: "current"}).nodes().indexOf(h.parent()[0]),
                column: h.index()
            };
            if (c.cell(h).any() && -1 !== c.columns(this.c.columns).indexes().indexOf(f.column)) {
                this.s.end = f;
                var g, k, b = a.row < f.row ? d : h;
                g = a.row < f.row ? h : d;
                ...
                if ((g = this.dom.dtScroll) && this.dom.offsetParent[0] !== c.table().node())b +=
                    g.scrollTop(), k += g.scrollLeft();
                c = this.dom.select;
            ...
            var c = this.s.dt, a = this.c.editor;
            if (a) {
                for (var d = {}, h = [], e = a.fields(), g = 0, k = b.length; g < k; g++)for (var i = 0, m = b[g].length; i < m; i++) {
                    var n = b[g][i], j = c.settings()[0].aoColumns[n.index.column], l = j.editField;
                    if (l === q)for (var j = j.mData, p = 0, o = e.length; p < o; p++) {
                        var r = a.field(e[p]);
                        if (r.dataSrc() ===
                            j) {
                            l = r.name();
                    ...
                    if (!l)throw"Could not automatically determine field data. Please see https://datatables.net/tn/11";
                    d[l] || (d[l] = {});
            ...
            var b = this, c = this.s.dt, a = this.s.namespace, d = null !== this.c.focus ? this.c.focus : c.settings()[0].keytable ? "focus" : "hover";
            if ("focus" === d)c.on("key-focus.autoFill",
                function (a, c, d) {
                    b._attach(d.node())
                }).on("key-blur.autoFill", function () {
                    b._detach()
                }); else if ("click" === d)e(c.table().body()).on("click" + a, "td, th", function () {
                b._attach(this)
            }), e(i.body).on("click" + a, function (a) {
                e(a.target).parents().filter(c.table().body()).length || b._detach()
            }); else e(c.table().body()).on("mouseenter" + a, "td, th", function () {
                b._attach(this)
            }).on("mouseleave" + a, function (a) {
                e(a.relatedTarget).hasClass("dt-autofill-handle") || b._detach()
            })
        }, _mousedown: function (b) {
            var c = this, a = this.s.dt;
            ...
            var b = this.s.dt, c = this.dom.select;
            c.top.remove();
            c.left.remove();
            c.right.remove();
            c.bottom.remove();
            this.dom.handle.css("display",
                "block");
            var c = this.s.start, a = this.s.end;
            if (!(c.row === a.row && c.column === a.column)) {
                for (var d = this._range(c.row, a.row), c = this._range(c.column, a.column), a = [], h = b.settings()[0], f = h.aoColumns, g = 0; g < d.length; g++)a.push(e.map(c, function (a) {
                    var a = b.cell(":eq(" + d[g] + ")", a + ":visible", {page: "current"}), c = a.data(), e = a.index(), i = f[e.column].editField;
                    i !== q && (c = h.oApi._fnGetObjectDataFn(i)(b.row(e.row).data()));
            ...
            var a = [], d;
            if (b <= c)for (d = b; d <= c; d++)a.push(d); else for (d = b; d >= c; d--)a.push(d);
            return a
        }, _shiftScroll: function (b) {
            var c = this, a = this.s.scroll, d = !1, e = b.pageY - i.body.scrollTop, f = b.pageX - i.body.scrollLeft, g, k, j, l;
            65 > e ? g = -5 : e > a.windowHeight - 65 && (g = 5);
            65 > f ? k = -5 : f > a.windowWidth - 65 && (k = 5);
            null !== a.dtTop && b.pageY < a.dtTop + 65 ? j = -5 : null !== a.dtTop && b.pageY > a.dtTop + a.dtHeight - 65 && (j = 5);
            null !== a.dtLeft && b.pageX < a.dtLeft + 65 ? l = -5 : null !== a.dtLeft && b.pageX > a.dtLeft + a.dtWidth -
            65 && (l = 5);
            g || k || j || l ? (a.windowVert = g, a.windowHoriz = k, a.dtVert = j, a.dtHoriz = l, d = !0) : this.s.scrollInterval && (clearInterval(this.s.scrollInterval), this.s.scrollInterval = null);
            ...
            if (!1 !== b) {
                ...
                if (null !== this.c.update ? this.c.update : !this.c.editor) {
                    for (var e = 0, f = c.length; e < f; e++)for (var g = 0, i = c[e].length; g < i; g++)d = c[e][g], d.cell.data(d.set);
                    a.draw(!1)
                }
    ...
    m.actions = {
        increment: {
            ...
            execute: function (b, c, a) {
                for (var b = 1 * c[0][0].data, a = 1 * e("input", a).val(), d = 0, h = c.length; d < h; d++)for (var f = 0, g = c[d].length; f < g; f++)c[d][f].set = b, b += a
            }
        }, fill: {
            available: function () {
                return !0
            }, option: function (b, c) {
                return b.i18n("autoFill.fill", "Fill all cells with <i>" + c[0][0].label + "</i>")
            }, execute: function (b, c) {
                for (var a = c[0][0].data, d = 0, e = c.length; d < e; d++)for (var f = 0, g = c[d].length; f < g; f++)c[d][f].set = a
            }
        }, fillHorizontal: {
            available: function (b, c) {
                return 1 < c.length && 1 < c[0].length
            }, option: function (b) {
                return b.i18n("autoFill.fillHorizontal",
                    "Fill cells horizontally")
            }, execute: function (b, c) {
                for (var a = 0, d = c.length; a < d; a++)for (var e = 0, f = c[a].length; e < f; e++)c[a][e].set = c[a][0].data
            }
        }, fillVertical: {
            available: function (b, c) {
                return 1 < c.length && 1 < c[0].length
                ...
                for (var a = 0, d = c.length; a < d; a++)for (var e = 0, f = c[a].length; e < f; e++)c[a][e].set = c[0][e].data
            }
        }, cancel: {
            available: function () {
                return !1
            }, option: function (b) {
                return b.i18n("autoFill.cancel",
                    "Cancel")
            }, execute: function () {
                return !1
            }
    ...
    m.version = "2.1.2";
    m.defaults = {alwaysAsk: !1, focus: null, columns: "", update: null, editor: null};
    m.classes = {btn: "btn"};
    e(i).on("preInit.dt.autofill", function (b, c) {
        if ("dt" === b.namespace) {
            var a = c.oInit.autoFill, d = l.defaults.autoFill;
...
(function (f) {
            ...
            if (f.isPlainObject(d))v(d); else {
                if (n) {
                    ...
                    for (e = c.attributes.length - 1; 0 <= e; e--) {
                        ...
                        -1 !== g.indexOf(":") && (h.push({name: g, value: q}), c.removeAttribute(g))
                    }
                    e = 0;
    ...
    h.Client.prototype = {
        ...
        receiveEvent: function (a, b) {
            ...
            if (this.handlers[a])for (var c =
                ...
                if ("function" == typeof g)g(this, b); else if ("object" == typeof g && 2 == g.length)g[0][g[1]](this, b); else if ("string" == typeof g)j[g](this, b)
            }
        }
    };
    h.hasFlash = function () {
    ...
    i.ext.buttons.excelFlash = f.extend({}, t, {
        ...
        text: function (a) {
            ...
            var a = c._flash, e = 0, g = f.parseXML(p["xl/worksheets/sheet1.xml"]), h = g.getElementsByTagName("sheetData")[0], d = {
                    _rels: {".rels": f.parseXML(p["_rels/.rels"])},
                    xl: {
                        _rels: {"workbook.xml.rels": f.parseXML(p["xl/_rels/workbook.xml.rels"])},
    ...
    i.ext.buttons.pdfFlash = f.extend({}, t, {
        className: "buttons-pdf buttons-flash", text: function (a) {
            ...
            var a = c._flash, e = b.buttons.exportData(c.exportOptions), g = b.table().node().offsetWidth, f = b.columns(c.columns).indexes().map(function (a) {
...
(function (e) {
    ...
    var j = e.fn.dataTable, i = function (b, a) {
        if (!j.versionCheck || !j.versionCheck("1.10.8"))throw"DataTables RowReorder requires DataTables 1.10.8 or newer";
        this.c = e.extend(!0, {}, j.defaults.rowReorder,
            i.defaults, a);
        this.s = {
            bodyTop: null,
            dt: new j.Api(b),
        ...
        var c = this.s.dt.settings()[0], d = c.rowreorder;
        if (d)return d;
        c.rowreorder = this;
        this._constructor()
    };
    e.extend(i.prototype, {
        _constructor: function () {
            var b =
                this, a = this.s.dt, c = e(a.table().node());
            "static" === c.css("position") && c.css("position", "relative");
            e(a.table().container()).on("mousedown.rowReorder touchstart.rowReorder", this.c.selector, function (d) {
            ...
            var b = this.s.dt, a = e(b.table().node()).find("thead").outerHeight(), c = e.unique(b.rows({page: "current"}).nodes().toArray()),
                d = e.map(c, function (b) {
                    ...
                    return d.length < c - 1 ? (a + d[c + 1]) / 2 : (a + a + e(b.row(":last-child").node()).outerHeight()) / 2
                });
            this.s.middles = c;
            this.s.bodyTop = e(b.table().body()).offset().top;
            this.s.windowHeight = e(f).height()
        }, _clone: function (b) {
            var a = e(this.s.dt.table().node().cloneNode(!1)).addClass("dt-rowReorder-float").append("<tbody/>").append(b.clone(!1)), c = b.outerWidth(), d = b.outerHeight(), h = b.children().map(function () {
                return e(this).width()
            });
            a.width(c).height(d).find("tr").children().each(function (a) {
                this.style.width =
                    h[a] + "px"
            });
            a.appendTo("body");
            ...
            var a = this.s.start, c = this._eventToPage(b, "Y") - a.top, b = this._eventToPage(b, "X") - a.left, d = this.c.snapX;
            this.dom.clone.css({
                top: c + a.offsetTop,
                left: !0 === d ? a.offsetLeft : "number" === typeof d ? a.offsetLeft + d : b + a.offsetLeft
            })
            ...
            var c = this, d = this.s.dt, h = this.s.start, k = a.offset();
            ...
            this._clonePosition(b);
            for (var a = this._eventToPage(b, "Y") - this.s.bodyTop, c = this.s.middles, d = null, h = this.s.dt, k = h.table().body(), g = 0, f = c.length; g < f; g++)if (a < c[g]) {
                d = g;
                break
            }
            null === d && (d = c.length);
            if (null === this.s.lastInsert || this.s.lastInsert !== d)0 === d ? this.dom.target.prependTo(k) : (a = e.unique(h.rows({page: "current"}).nodes().toArray()), d > this.s.lastInsert ? this.dom.target.insertAfter(a[d - 1]) : this.dom.target.insertBefore(a[d])), this._cachePositions(), this.s.lastInsert = d;
            this._shiftScroll(b)
        }, _mouseUp: function () {
            var b = this.s.dt, a, c, d = this.c.dataSrc;
            ...
            clearInterval(this.s.scrollInterval);
            this.s.scrollInterval = null;
            var h = this.s.start.nodes, k = e.unique(b.rows({page: "current"}).nodes().toArray()), f = {}, l = [], i = [], j = this.s.getDataFn, o = this.s.setDataFn;
            a = 0;
            for (c = h.length; a < c; a++)if (h[a] !== k[a]) {
                var m = b.row(k[a]).id(), p = b.row(k[a]).data(), n = b.row(h[a]).data();
                m && (f[m] = j(n));
                l.push({node: k[a], oldData: j(p), newData: j(n), newPosition: a, oldPosition: e.inArray(k[a], h)});
                i.push(k[a])
            }
            h = [l, {
            ...
            this.c.editor && this.c.editor.edit(i, !1, {submit: "changed"}).multiSet(d, f).submit();
            if (this.c.update) {
                a = 0;
                for (c = l.length; a < c; a++)f = b.row(l[a].node).data(), o(f, l[a].newData), b.columns().every(function () {
                    this.dataSrc() === d && b.cell(l[a].node, this.index()).invalidate("data")
                });
                this._emitEvent("row-reordered", h);
                b.draw(!1)
            }
        }, _shiftScroll: function (b) {
            var a = this, c = this.s.scroll, d = !1, e = b.pageY - g.body.scrollTop, f, i;
            65 > e ? f = -5 : e > c.windowHeight -
            65 && (f = 5);
            null !== c.dtTop && b.pageY < c.dtTop + 65 ? i = -5 : null !== c.dtTop && b.pageY > c.dtTop + c.dtHeight - 65 && (i = 5);
            f || i ? (c.windowVert = f, c.dtVert = i, d = !0) : this.s.scrollInterval && (clearInterval(this.s.scrollInterval), this.s.scrollInterval = null);
            !this.s.scrollInterval && d && (this.s.scrollInterval = setInterval(function () {
    ...
    e(g).on("init.dt.dtr", function (b, a) {
        if ("dt" === b.namespace) {
            var c = a.oInit.rowReorder, d = j.defaults.rowReorder;
...
(function (e) {
    ...
    e.extend(g.prototype, {
        ...
        _fnScroll: function () {
            ...
            var e = (c.scroll - c.viewport) / 2, i = (c.virtual -
                c.viewport) / 2;
            d = i / (e * e);
            ...
            var a = this, b = this.s.heights, c = this.dom.scroller.scrollTop, d = e(this.s.dt.nTable).height(), f = this.s.dt._iDisplayStart, i = this.s.dt._iDisplayLength, g = this.s.dt.fnRecordsDisplay();
            this.s.skip = !0;
            this._fnScrollForce();
