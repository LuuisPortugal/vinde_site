 ...
 */
    ...
    return !function e(t, i, a) {
        ...
        1: [function (t, e, i) {
            !function () {
                var i = t("color-convert"), a = t("color-string"), s = function (t) {
                    ...
                    if (this.values = {
                        ...
                        var e = a.getRgba(t);
                        if (e)this.setValues("rgb", e); else if (e = a.getHsla(t))this.setValues("hsl", e); else {
                ...
                s.prototype = {
                    ...
                    if ("alpha" == t)o = e; else if (e.length)this.values[t] = e.slice(0, t.length), o = e[t.length]; else if (void 0 !== e[t.charAt(0)]) {
                        ...
                        for (var r = a[t], n = 0; n < t.length; n++)this.values[t][n] = e[r[n]];
                        o = e.alpha
                    }
                    if (this.values.alpha = Math.max(0, Math.min(1, void 0 !== o ? o : this.values.alpha)), "alpha" != t) {
                        ...
                        for (var l in a) {
                            l != t && (this.values[l] = i[t][l](this.values[t]));
        ...
        }, {"color-convert": 3, "color-string": 4}], 2: [function (t, e, i) {
            function a(t) {
                var e, i, a, s = t[0] / 255, o = t[1] / 255, n = t[2] / 255, r = Math.min(s, o, n), h = Math.max(s, o, n), l = h - r;
            ...
            function s(t) {
                var e, i, a, s = t[0], o = t[1], n = t[2], r = Math.min(s, o, n), h = Math.max(s, o, n), l = h - r;
            ...
            function o(t) {
                var e = t[0], i = t[1], s = t[2], o = a(t)[0], n = 1 / 255 * Math.min(e, Math.min(i, s)), s = 1 - 1 / 255 * Math.max(e, Math.max(i, s));
                return [o, 100 * n, 100 * s]
            }

            function n(t) {
                var e, i, a, s, o = t[0] / 255, n = t[1] / 255, r = t[2] / 255;
            ...
            function l(t) {
                ...
                var s = .4124 * e + .3576 * i + .1805 * a, o = .2126 * e + .7152 * i + .0722 * a, n = .0193 * e + .1192 * i + .9505 * a;
                return [100 * s, 100 * o, 100 * n]
            }

            function c(t) {
                var e, i, a, s = l(t), o = s[0], n = s[1], r = s[2];
            ...
            function u(t) {
                var e, i, a, s, o, n = t[0] / 360, r = t[1] / 100, h = t[2] / 100;
            ...
            function m(t) {
                var e, i, a = t[0], s = t[1] / 100, o = t[2] / 100;
                return o *= 2, s *= 1 >= o ? o : 2 - o, i = (o + s) / 2, e = 2 * s / (o + s), [a, 100 * e, 100 * i]
            }
            ...
            function v(t) {
                var e = t[0] / 60, i = t[1] / 100, a = t[2] / 100, s = Math.floor(e) % 6, o = e - Math.floor(e), n = 255 * a * (1 - i), r = 255 * a * (1 - i * o), h = 255 * a * (1 - i * (1 - o)), a = 255 * a;
                switch (s) {
                    case 0:
                        return [a, h, n];
                    case 1:
            ...
            function S(t) {
                var e, i, a, s, o = t[0] / 360, n = t[1] / 100, h = t[2] / 100, l = n + h;
            ...
            function I(t) {
                var e, i, a, s = t[0] / 100, o = t[1] / 100, n = t[2] / 100, r = t[3] / 100;
            ...
            function z(t) {
                var e, i, a, s = t[0] / 100, o = t[1] / 100, n = t[2] / 100;
            ...
            var a = t("./conversions"), s = function () {
                return new l
            };
            for (var o in a) {
                s[o + "Raw"] = function (t) {
                ...
                var n = /(\w+)2(\w+)/.exec(o), r = n[1], h = n[2];
        ...
        }, {"./conversions": 2}], 4: [function (t, e, i) {
            function a(t) {
                if (t) {
                    var e = /^#([a-fA-F0-9]{3})$/, i = /^#([a-fA-F0-9]{6})$/, a = /^rgba?\(\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/, s = /^rgba?\(\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/, o = /(\w+)/, n = [0, 0, 0], r = 1, h = t.match(e);
                    if (h) {
                        h = h[1];
            ...
            function s(t) {
                if (t) {
                    ...
                    if (i) {
                        var a = parseFloat(i[4]), s = x(parseInt(i[1]), 0, 360), o = x(parseFloat(i[2]), 0, 100), n = x(parseFloat(i[3]), 0, 100), r = x(isNaN(a) ? 1 : a, 0, 1);
                        return [s, o, n, r]
                    }
                }
            }
            ...
            function u(t, e) {
                ...
                var i = Math.round(t[0] / 255 * 100), a = Math.round(t[1] / 255 * 100), s = Math.round(t[2] / 255 * 100);
                return "rgb(" + i + "%, " + a + "%, " + s + "%)"
            }
            ...
            function m(t, e) {
                return 1 > e || t[3] && t[3] < 1 ? f(t, e) : "hsl(" + t[0] + ", " + t[1] + "%, " + t[2] + "%)"
            }
            ...
            var k = {};
            for (var C in y)k[y[C]] = C
        }, {"color-name": 5}], 5: [function (t, e, i) {
            e.exports = {
                aliceblue: [240, 248, 255],
                antiquewhite: [250, 235, 215],
                aqua: [0, 255, 255],
        ...
        "use strict";
        var t = this, e = t.Chart, i = function (t, e) {
        ...
        "use strict";
        var t = this, e = t.Chart, i = e.helpers = {}, a = i.each = function (t, e, i, a) {
            var s = Array.prototype.slice.call(arguments, 3);
            if (t)if (t.length === +t.length) {
                var o;
                if (a)for (o = t.length - 1; o >= 0; o--)e.apply(i, [t[o], o].concat(s)); else for (o = 0; o < t.length; o++)e.apply(i, [t[o], o].concat(s))
            } else for (var n in t)e.apply(i, [t[n], n].concat(s))
        }, s = i.clone = function (t) {
            var e = {};
            return a(t, function (a, o) {
                t.hasOwnProperty(o) && (i.isArray(a) ? e[o] = a.slice(0) : "object" == typeof a && null !== a ? e[o] = s(a) : e[o] = a)
            }), e
        ...
        }, n = (i.configMerge = function (t) {
            var a = s(t);
            return i.each(Array.prototype.slice.call(arguments, 1), function (t) {
                i.each(t, function (s, o) {
                    if (t.hasOwnProperty(o))if ("scales" === o)a[o] = i.scaleMerge(a.hasOwnProperty(o) ? a[o] : {}, s); else if ("scale" === o)a[o] = i.configMerge(a.hasOwnProperty(o) ? a[o] : {}, e.scaleService.getScaleDefaults(s.type), s); else if (a.hasOwnProperty(o) && i.isArray(a[o]) && i.isArray(s)) {
                        var n = a[o];
                        i.each(s, function (t, e) {
                            e < n.length ? "object" == typeof n[e] && null !== n[e] && "object" == typeof t && null !== t ? n[e] = i.configMerge(n[e], t) : n[e] = t : n.push(t)
                        })
                    } else a.hasOwnProperty(o) && "object" == typeof a[o] && null !== a[o] && "object" == typeof s ? a[o] = i.configMerge(a[o], s) : a[o] = s
                })
            }), a
        }, i.extendDeep = function (t) {
            function e(t) {
                return i.each(arguments, function (a) {
                    a !== t && i.each(a, function (i, a) {
        ...
        }, i.scaleMerge = function (t, a) {
            var o = s(t);
            return i.each(a, function (t, s) {
                a.hasOwnProperty(s) && ("xAxes" === s || "yAxes" === s ? o.hasOwnProperty(s) ? i.each(t, function (t, a) {
                    a >= o[s].length || !o[s][a].type ? o[s].push(i.configMerge(t.type ? e.scaleService.getScaleDefaults(t.type) : {}, t)) : t.type !== o[s][a].type ? o[s][a] = i.configMerge(o[s][a], t.type ? e.scaleService.getScaleDefaults(t.type) : {}, t) : o[s][a] = i.configMerge(o[s][a], t)
                }) : (o[s] = [], i.each(t, function (t) {
                    o[s].push(i.configMerge(t.type ? e.scaleService.getScaleDefaults(t.type) : {}, t))
                })) : o.hasOwnProperty(s) && "object" == typeof o[s] && null !== o[s] && "object" == typeof t ? o[s] = i.configMerge(o[s], t) : o[s] = t)
            }), o
        }, i.getValueAtIndexOrDefault = function (t, e, a) {
            return void 0 === t || null === t ? a : i.isArray(t) ? e < t.length ? t[e] : a : t
            ...
            return a.prototype = e.prototype, i.prototype = new a, i.extend = n, t && o(i.prototype, t), i.__super__ = e.prototype, i
        }), r = i.noop = function () {
        }, h = (i.uid = function () {
            var t = 0;
            return function () {
            ...
            var i = e.x - t.x, a = e.y - t.y, s = Math.sqrt(i * i + a * a), o = Math.atan2(a, i);
            return o < -.5 * Math.PI && (o += 2 * Math.PI), {angle: o, distance: s}
        }, i.aliasPixel = function (t) {
            return t % 2 === 0 ? 0 : .5
        }, i.splineCurve = function (t, e, i, a) {
            var s = t.skip ? e : t, o = e, n = i.skip ? e : i, r = Math.sqrt(Math.pow(o.x - s.x, 2) + Math.pow(o.y - s.y, 2)), h = Math.sqrt(Math.pow(n.x - o.x, 2) + Math.pow(n.y - o.y, 2)), l = r / (r + h), c = h / (r + h);
            l = isNaN(l) ? 0 : l, c = isNaN(c) ? 0 : c;
            var d = a * l, u = a * c;
            return {
                previous: {x: o.x - d * (n.x - s.x), y: o.y - d * (n.y - s.y)},
            ...
            var a, s = Math.floor(i.log10(t)), o = t / Math.pow(10, s);
            return a = e ? 1.5 > o ? 1 : 3 > o ? 2 : 7 > o ? 5 : 10 : 1 >= o ? 1 : 2 >= o ? 2 : 5 >= o ? 5 : 10, a * Math.pow(10, s)
        }, i.easingEffects = {
            linear: function (t) {
                return t
            ...
            var i, a, s = t.originalEvent || t, o = t.currentTarget || t.srcElement, n = o.getBoundingClientRect();
            return s.touches && s.touches.length > 0 ? (i = s.touches[0].clientX, a = s.touches[0].clientY) : (i = s.clientX, a = s.clientY), i = Math.round((i - n.left) / (n.right - n.left) * o.width / e.currentDevicePixelRatio), a = Math.round((a - n.top) / (n.bottom - n.top) * o.height / e.currentDevicePixelRatio), {
                x: i,
                y: a
            }
        }, i.addEvent = function (t, e, i) {
            t.addEventListener ? t.addEventListener(e, i) : t.attachEvent ? t.attachEvent("on" + e, i) : t["on" + e] = i
        }), d = i.removeEvent = function (t, e, i) {
            t.removeEventListener ? t.removeEventListener(e, i, !1) : t.detachEvent ? t.detachEvent("on" + e, i) : t["on" + e] = r
        }, u = (i.bindEvents = function (t, e, i) {
            ...
            var e, i = document.defaultView.getComputedStyle(t)["max-width"], a = document.defaultView.getComputedStyle(t.parentNode)["max-width"], s = null !== i && "none" !== i, o = null !== a && "none" !== a;
            return (s || o) && (e = Math.min(s ? parseInt(i, 10) : Number.POSITIVE_INFINITY, o ? parseInt(a, 10) : Number.POSITIVE_INFINITY)), e
        }), g = i.getConstraintHeight = function (t) {
            var e, i = document.defaultView.getComputedStyle(t)["max-height"], a = document.defaultView.getComputedStyle(t.parentNode)["max-height"], s = null !== i && "none" !== i, o = null !== a && "none" !== a;
            return (i || a) && (e = Math.min(s ? parseInt(i, 10) : Number.POSITIVE_INFINITY, o ? parseInt(a, 10) : Number.POSITIVE_INFINITY)), e
        }, m = (i.getMaximumWidth = function (t) {
            var e = t.parentNode, i = parseInt(m(e, "padding-left")) + parseInt(m(e, "padding-right")), a = e.clientWidth - i, s = u(t);
            return void 0 !== s && (a = Math.min(a, s)), a
        }, i.getMaximumHeight = function (t) {
            var e = t.parentNode, i = parseInt(m(e, "padding-top")) + parseInt(m(e, "padding-bottom")), a = e.clientHeight - i, s = g(t);
            return void 0 !== s && (a = Math.min(a, s)), a
        }, i.getStyle = function (t, e) {
            return t.currentStyle ? t.currentStyle[e] : document.defaultView.getComputedStyle(t, null).getPropertyValue(e)
        });
        i.getMaximumSize = i.getMaximumWidth, i.retinaScale = function (t) {
            var e = t.ctx, i = t.canvas.width, a = t.canvas.height, s = t.currentDevicePixelRatio = window.devicePixelRatio || 1;
            1 !== s && (e.canvas.height = a * s, e.canvas.width = i * s, e.scale(s, s), e.canvas.style.width = i + "px", e.canvas.style.height = a + "px", t.originalDevicePixelRatio = t.originalDevicePixelRatio || s)
        }, i.clear = function (t) {
            t.ctx.clearRect(0, 0, t.width, t.height)
        }, i.fontString = function (t, e, i) {
            return e + " " + t + "px " + i
        }, i.longestText = function (t, e, i) {
            t.font = e;
            var s = 0;
        ...
        }, i.drawRoundedRectangle = function (t, e, i, a, s, o) {
            ...
            i.classlist ? i.classlist.add(a) : i.setAttribute("class", a), i.style.width = "100%", i.style.display = "block", i.style.border = 0, i.style.height = 0, i.style.margin = 0, i.style.position = "absolute", i.style.left = 0, i.style.right = 0, i.style.top = 0, i.style.bottom = 0, t.insertBefore(i, t.firstChild);
        ...
        e.elements = {}, e.Element = function (t) {
            ...
            initialize: function () {
                ...
                return this._view || (this._view = i.clone(this._model)), this._start || this.pivot(), i.each(this._model, function (e, a) {
                    if ("_" !== a[0] && this._model.hasOwnProperty(a))if (this._view[a])if (this._model[a] === this._view[a]); else if ("string" == typeof e)try {
                        var s = i.color(this._start[a]).mix(i.color(this._model[a]), t);
                    ...
                    } else this._view[a] = e; else"number" == typeof e && isNaN(this._view[a]) === !1 ? this._view[a] = e * t : this._view[a] = e || null; else;
        ...
        e.defaults.global.animation = {
            ...
            startDigest: function () {
                ...
                for (var a = 0; a < this.animations.length; a++)null === this.animations[a].animationObject.currentStep && (this.animations[a].animationObject.currentStep = 0), this.animations[a].animationObject.currentStep += 1 + e, this.animations[a].animationObject.currentStep > this.animations[a].animationObject.numSteps && (this.animations[a].animationObject.currentStep = this.animations[a].animationObject.numSteps), this.animations[a].animationObject.render(this.animations[a].chartInstance, this.animations[a].animationObject), this.animations[a].animationObject.onAnimationProgress && this.animations[a].animationObject.onAnimationProgress.call && this.animations[a].animationObject.onAnimationProgress.call(this.animations[a].chartInstance, this.animations[a]), this.animations[a].animationObject.currentStep == this.animations[a].animationObject.numSteps && (this.animations[a].animationObject.onAnimationComplete && this.animations[a].animationObject.onAnimationComplete.call && this.animations[a].animationObject.onAnimationComplete.call(this.animations[a].chartInstance, this.animations[a]), this.animations[a].chartInstance.animating = !1, this.animations.splice(a, 1), a--);
                var s = Date.now(), o = (s - t) / this.frameDuration;
                this.dropFrames += o, this.animations.length > 0 && i.requestAnimFrame.call(window, this.digestWrapper)
            }
        }
    }.call(this), function () {
        "use strict";
        ...
        e.types = {}, e.instances = {}, e.controllers = {}, e.Controller = function (t) {
            ...
            initialize: function () {
                ...
                this.stop();
                var e = this.chart.canvas, a = i.getMaximumWidth(this.chart.canvas), s = this.options.maintainAspectRatio && isNaN(this.chart.aspectRatio) === !1 && isFinite(this.chart.aspectRatio) && 0 !== this.chart.aspectRatio ? a / this.chart.aspectRatio : i.getMaximumHeight(this.chart.canvas);
                return e.width = this.chart.width = a, e.height = this.chart.height = s, i.retinaScale(this.chart), t || this.update(this.options.responsiveAnimationDuration), this
            }, ensureScalesHaveIDs: function () {
                var t = "x-axis-", e = "y-axis-";
                ...
                if (this.scales = {}, this.options.scales && (this.options.scales.xAxes && this.options.scales.xAxes.length && i.each(this.options.scales.xAxes, function (t, i) {
                        var a = e.scaleService.getScaleConstructor(t.type), s = new a({
                            ctx: this.chart.ctx,
                            options: t,
                            chart: this,
                            id: t.id
                    ...
                    var t = e.scaleService.getScaleConstructor(this.options.scale.type), a = new t({
                        ctx: this.chart.ctx,
            ...
            }, buildOrUpdateControllers: function (t) {
                var a = [];
                if (i.each(this.data.datasets, function (i, s) {
                        i.type || (i.type = this.config.type);
                        var o = i.type;
                        a.push(o), i.controller ? i.controller.updateIndex(s) : (i.controller = new e.controllers[o](this, s), t && i.controller.reset())
                    }, this), a.length > 1)for (var s = 1; s < a.length; s++)if (a[s] != a[s - 1]) {
                    this.isCombo = !0;
                    break
                }
                ...
                this.tooltip._data = this.data, this.buildOrUpdateControllers(!0), e.layoutService.update(this, this.chart.width, this.chart.height), i.each(this.data.datasets, function (t, e) {
                    t.controller.buildOrUpdateElements()
                }, this), i.each(this.data.datasets, function (t, e) {
                    t.controller.update()
                }, this), this.render(t, a)
            }, render: function (t, a) {
                if (this.options.animation && ("undefined" != typeof t && 0 !== t || "undefined" == typeof t && 0 !== this.options.animation.duration)) {
                    var s = new e.Animation;
                    s.numSteps = (t || this.options.animation.duration) / 16.66, s.easing = this.options.animation.easing, s.render = function (t, e) {
                        var a = i.easingEffects[e.easing], s = e.currentStep / e.numSteps, o = a(s);
                        t.draw(o, s, e.currentStep)
                    }, s.onAnimationProgress = this.options.animation.onProgress, s.onAnimationComplete = this.options.animation.onComplete, e.animationService.addAnimation(this, s, t, a)
                ...
                }, this), this.scale && this.scale.draw(), i.each(this.data.datasets, function (e, a) {
                    i.isDatasetVisible(e) && e.controller.draw(t)
                }, this), this.tooltip.transition(e).draw()
            }, getElementAtEvent: function (t) {
                var e = i.getRelativePosition(t, this.chart), a = [];
                return i.each(this.data.datasets, function (t, s) {
                    i.isDatasetVisible(t) && i.each(t.metaData, function (t, i) {
                        return t.inRange(e.x, e.y) ? (a.push(t), a) : void 0
                    }, this)
                }, this), a
            }, getElementsAtEvent: function (t) {
                var e = i.getRelativePosition(t, this.chart), a = [], s = function () {
                    for (var t = 0; t < this.data.datasets.length; t++)if (i.isDatasetVisible(this.data.datasets[t]))for (var a = 0; a < this.data.datasets[t].metaData.length; a++)if (this.data.datasets[t].metaData[a].inRange(e.x, e.y))return this.data.datasets[t].metaData[a]
                }.call(this);
                return s ? (i.each(this.data.datasets, function (t, e) {
                    i.isDatasetVisible(t) && a.push(t.metaData[s._index])
                }, this), a) : a
        ...
        e.DatasetController = function (t, e) {
            ...
            buildOrUpdateElements: function () {
                var t = this.getDataset().data.length, e = this.getDataset().metaData.length;
                if (e > t)this.getDataset().metaData.splice(t, e - t); else if (t > e)for (var i = e; t > i; ++i)this.addElementAndReset(i)
            },
            addElements: i.noop,
        ...
        e.layoutService = {
            defaults: {}, addBox: function (t, e) {
                ...
                function s(t) {
                    ...
                    i ? (e = t.update(t.options.fullWidth ? f : k, y), C -= e.height) : (e = t.update(v, x), k -= e.width), D.push({
                        horizontal: i,
                        minSize: e,
                        box: t
                    })
                ...
                function o(t) {
                    ...
                    if (e)if (t.isHorizontal()) {
                        var a = {left: S, right: w, top: 0, bottom: 0};
                        t.update(t.options.fullWidth ? f : k, e.minSize.height, a)
                ...
                function n(t) {
                    ...
                    e && t.update(e.minSize.width, C, a)
                }

                function r(t) {
                    t.isHorizontal() ? (t.left = t.options.fullWidth ? h : S, t.right = t.options.fullWidth ? e - h : S + k, t.top = F, t.bottom = F + t.height, F = t.bottom) : (t.left = P, t.right = P + t.width, t.top = _, t.bottom = _ + C, P = t.right)
                }

                if (t) {
                    var h = e > 30 ? 5 : 2, l = a > 30 ? 5 : 2, c = i.where(t.boxes, function (t) {
                        return "left" == t.options.position
                    }), d = i.where(t.boxes, function (t) {
                        return "right" == t.options.position
                    }), u = i.where(t.boxes, function (t) {
                        return "top" == t.options.position
                    }), g = i.where(t.boxes, function (t) {
                        return "bottom" == t.options.position
                    }), m = i.where(t.boxes, function (t) {
                    ...
                    var f = e - 2 * h, p = a - 2 * l, b = f / 2, x = p / 2, v = (e - b) / (c.length + d.length), y = (a - x) / (u.length + g.length), k = f, C = p, D = [];
                    i.each(c.concat(d, u, g), s);
                    var S = h, w = h, _ = l, A = l;
                    i.each(c.concat(d), o), i.each(c, function (t) {
                        S += t.width
                    }), i.each(d, function (t) {
                        w += t.width
                    }), i.each(u.concat(g), o), i.each(u, function (t) {
                        _ += t.height
                    }), i.each(g, function (t) {
                        A += t.height
                    }), i.each(c.concat(d), n), S = h, w = h, _ = l, A = l, i.each(c, function (t) {
                        S += t.width
                    }), i.each(d, function (t) {
                        w += t.width
                    }), i.each(u, function (t) {
                    ...
                    var P = h, F = l;
                    i.each(c.concat(u), r), P += k, F += C, i.each(d, r), i.each(g, r), t.chartArea = {
                        left: S,
                        top: _,
                        right: S + k,
                        bottom: _ + C
        ...
        e.defaults.global.legend = {
            ...
            initialize: function (t) {
            ...
            }, beforeUpdate: i.noop, update: function (t, e, i) {
            ...
            }, afterUpdate: i.noop, beforeSetDimensions: i.noop, setDimensions: function () {
            ...
            }, afterSetDimensions: i.noop, beforeBuildLabels: i.noop, buildLabels: function () {
                this.legendItems = this.options.labels.generateLabels.call(this, this.chart.data)
            }, afterBuildLabels: i.noop, beforeFit: i.noop, fit: function () {
                var t = this.ctx, e = i.fontString(this.options.labels.fontSize, this.options.labels.fontStyle, this.options.labels.fontFamily);
                if (this.legendHitBoxes = [], this.isHorizontal() ? this.minSize.width = this.maxWidth : this.minSize.width = this.options.display ? 10 : 0, this.isHorizontal() ? this.minSize.height = this.options.display ? 10 : 0 : this.minSize.height = this.maxHeight, this.options.display && this.isHorizontal()) {
                    this.lineWidths = [0];
                    var a = this.legendItems.length ? this.options.labels.fontSize + this.options.labels.padding : 0;
                    t.textAlign = "left", t.textBaseline = "top", t.font = e, i.each(this.legendItems, function (e, i) {
                        var s = this.options.labels.boxWidth + this.options.labels.fontSize / 2 + t.measureText(e.text).width;
                        this.lineWidths[this.lineWidths.length - 1] + s >= this.width && (a += this.options.labels.fontSize + this.options.labels.padding, this.lineWidths[this.lineWidths.length] = this.left), this.legendHitBoxes[i] = {
                            left: 0,
                            top: 0,
                            width: s,
                            height: this.options.labels.fontSize
                        }, this.lineWidths[this.lineWidths.length - 1] += s + this.options.labels.padding
                    }, this), this.minSize.height += a
                }
                this.width = this.minSize.width, this.height = this.minSize.height
            }, afterFit: i.noop, isHorizontal: function () {
                ...
                if (this.options.display) {
                    var t = this.ctx, a = {
                        ...
                        line: 0
                    }, s = i.fontString(this.options.labels.fontSize, this.options.labels.fontStyle, this.options.labels.fontFamily);
                    this.isHorizontal() && (t.textAlign = "left", t.textBaseline = "top", t.lineWidth = .5, t.strokeStyle = this.options.labels.fontColor, t.fillStyle = this.options.labels.fontColor, t.font = s, i.each(this.legendItems, function (i, s) {
                        var o = t.measureText(i.text).width, n = this.options.labels.boxWidth + this.options.labels.fontSize / 2 + o;
                        a.x + n >= this.width && (a.y += this.options.labels.fontSize + this.options.labels.padding, a.line++, a.x = this.left + (this.width - this.lineWidths[a.line]) / 2), t.save();
                        var r = function (t, e) {
                            return void 0 !== t ? t : e
                        };
                        t.fillStyle = r(i.fillStyle, e.defaults.global.defaultColor), t.lineCap = r(i.lineCap, e.defaults.global.elements.line.borderCapStyle), t.lineDashOffset = r(i.lineDashOffset, e.defaults.global.elements.line.borderDashOffset), t.lineJoin = r(i.lineJoin, e.defaults.global.elements.line.borderJoinStyle), t.lineWidth = r(i.lineWidth, e.defaults.global.elements.line.borderWidth), t.strokeStyle = r(i.strokeStyle, e.defaults.global.defaultColor), t.setLineDash && t.setLineDash(r(i.lineDash, e.defaults.global.elements.line.borderDash)), t.strokeRect(a.x, a.y, this.options.labels.boxWidth, this.options.labels.fontSize), t.fillRect(a.x, a.y, this.options.labels.boxWidth, this.options.labels.fontSize), t.restore(), this.legendHitBoxes[s].left = a.x, this.legendHitBoxes[s].top = a.y, t.fillText(i.text, this.options.labels.boxWidth + this.options.labels.fontSize / 2 + a.x, a.y), i.hidden && (t.beginPath(), t.lineWidth = 2, t.moveTo(this.options.labels.boxWidth + this.options.labels.fontSize / 2 + a.x, a.y + this.options.labels.fontSize / 2), t.lineTo(this.options.labels.boxWidth + this.options.labels.fontSize / 2 + a.x + o, a.y + this.options.labels.fontSize / 2), t.stroke()), a.x += n + this.options.labels.padding
                    }, this))
                }
            }, handleEvent: function (t) {
                var e = i.getRelativePosition(t, this.chart.chart);
                if (e.x >= this.left && e.x <= this.right && e.y >= this.top && e.y <= this.bottom)for (var a = 0; a < this.legendHitBoxes.length; ++a) {
                    var s = this.legendHitBoxes[a];
                    if (e.x >= s.left && e.x <= s.left + s.width && e.y >= s.top && e.y <= s.top + s.height) {
        ...
        e.defaults.scale = {
            ...
            beforeUpdate: function () {
                ...
                this.ctx.font = t;
                var e, a, s = this.ctx.measureText(this.ticks[0]).width, o = this.ctx.measureText(this.ticks[this.ticks.length - 1]).width;
                if (this.paddingRight = o / 2 + 3, this.paddingLeft = s / 2 + 3, this.labelRotation = 0, this.options.display && this.isHorizontal()) {
                    var n, r, h = i.longestText(this.ctx, t, this.ticks);
                    this.labelWidth = h;
                    for (var l = this.getPixelForTick(1) - this.getPixelForTick(0) - 6; this.labelWidth > l && this.labelRotation < this.options.ticks.maxRotation;) {
                        if (n = Math.cos(i.toRadians(this.labelRotation)), r = Math.sin(i.toRadians(this.labelRotation)), e = n * s, a = n * o, e + this.options.ticks.fontSize / 2 > this.yLabelWidth && (this.paddingLeft = e + this.options.ticks.fontSize / 2), this.paddingRight = this.options.ticks.fontSize / 2, r * h > this.maxHeight) {
                            this.labelRotation--;
                            break
                        }
                        this.labelRotation++, this.labelWidth = n * h
                    }
                ...
                if (this.minSize = {
                    ...
                    if (this.isHorizontal()) {
                        this.longestLabelWidth = i.longestText(this.ctx, t, this.ticks);
                        var e = Math.sin(i.toRadians(this.labelRotation)) * this.longestLabelWidth + 1.5 * this.options.ticks.fontSize;
                        this.minSize.height = Math.min(this.maxHeight, this.minSize.height + e), t = i.fontString(this.options.ticks.fontSize, this.options.ticks.fontStyle, this.options.ticks.fontFamily), this.ctx.font = t;
                        var a = this.ctx.measureText(this.ticks[0]).width, s = this.ctx.measureText(this.ticks[this.ticks.length - 1]).width, o = Math.cos(i.toRadians(this.labelRotation)), n = Math.sin(i.toRadians(this.labelRotation));
                        this.paddingLeft = 0 !== this.labelRotation ? o * a + 3 : a / 2 + 3, this.paddingRight = 0 !== this.labelRotation ? n * (this.options.ticks.fontSize / 2) + 3 : s / 2 + 3
                    } else {
                        var r = this.maxWidth - this.minSize.width, h = i.longestText(this.ctx, t, this.ticks);
                        this.options.ticks.mirror || (h += this.options.ticks.padding), r > h ? this.minSize.width += h : this.minSize.width = this.maxWidth, this.paddingTop = this.options.ticks.fontSize / 2, this.paddingBottom = this.options.ticks.fontSize / 2
                    }
                }
                ...
                return null === t || "undefined" == typeof t ? NaN : "number" == typeof t && isNaN(t) ? NaN : "object" == typeof t ? t instanceof Date ? t : a(this.isHorizontal() ? t.x : t.y) : t
            }, getLabelForIndex: i.noop, getPixelForValue: i.noop, getPixelForTick: function (t, e) {
                if (this.isHorizontal()) {
                    var i = this.width - (this.paddingLeft + this.paddingRight), a = i / Math.max(this.ticks.length - (this.options.gridLines.offsetGridLines ? 0 : 1), 1), s = a * t + this.paddingLeft;
                    e && (s += a / 2);
                ...
                if (this.isHorizontal()) {
                    var e = this.width - (this.paddingLeft + this.paddingRight), i = e * t + this.paddingLeft, a = this.left + Math.round(i);
                    return a += this.isFullWidth() ? this.margins.left : 0
                }
                return this.top + t * this.height
            }, draw: function (t) {
                if (this.options.display) {
                    var e, a, s, o, n = 0 !== this.labelRotation, r = this.options.ticks.autoSkip;
                    this.ctx.fillStyle = this.options.ticks.fontColor;
                    var h = i.fontString(this.options.ticks.fontSize, this.options.ticks.fontStyle, this.options.ticks.fontFamily), l = Math.cos(i.toRadians(this.labelRotation)), c = Math.sin(i.toRadians(this.labelRotation)), d = this.longestLabelWidth * l;
                    this.options.ticks.fontSize * c;
                    if (this.isHorizontal()) {
                        e = !0;
                        var u = "bottom" === this.options.position ? this.top : this.bottom - 10, g = "bottom" === this.options.position ? this.top + 10 : this.bottom;
                        a = !1, (d / 2 + this.options.ticks.autoSkipPadding) * this.ticks.length > this.width - (this.paddingLeft + this.paddingRight) && (a = 1 + Math.floor((d / 2 + this.options.ticks.autoSkipPadding) * this.ticks.length / (this.width - (this.paddingLeft + this.paddingRight)))), r || (a = !1), i.each(this.ticks, function (s, o) {
                            if (!(a > 1 && o % a > 0 || void 0 === s || null === s)) {
                                var r = this.getPixelForTick(o), l = this.getPixelForTick(o, this.options.gridLines.offsetGridLines);
                                this.options.gridLines.display && (o === ("undefined" != typeof this.zeroLineIndex ? this.zeroLineIndex : 0) ? (this.ctx.lineWidth = this.options.gridLines.zeroLineWidth, this.ctx.strokeStyle = this.options.gridLines.zeroLineColor, e = !0) : e && (this.ctx.lineWidth = this.options.gridLines.lineWidth, this.ctx.strokeStyle = this.options.gridLines.color, e = !1), r += i.aliasPixel(this.ctx.lineWidth), this.ctx.beginPath(), this.options.gridLines.drawTicks && (this.ctx.moveTo(r, u), this.ctx.lineTo(r, g)), this.options.gridLines.drawOnChartArea && (this.ctx.moveTo(r, t.top), this.ctx.lineTo(r, t.bottom)), this.ctx.stroke()), this.options.ticks.display && (this.ctx.save(), this.ctx.translate(l, n ? this.top + 12 : "top" === this.options.position ? this.bottom - 10 : this.top + 10), this.ctx.rotate(-1 * i.toRadians(this.labelRotation)), this.ctx.font = h, this.ctx.textAlign = n ? "right" : "center", this.ctx.textBaseline = n ? "middle" : "top" === this.options.position ? "bottom" : "top", this.ctx.fillText(s, 0, 0), this.ctx.restore())
                            }
                        ...
                        e = !0;
                        var m = "right" === this.options.position ? this.left : this.right - 5, f = "right" === this.options.position ? this.left + 5 : this.right;
                        if (i.each(this.ticks, function (a, s) {
                                if (void 0 !== a && null !== a) {
                                    var o = this.getPixelForTick(s);
                                    if (this.options.gridLines.display && (s === ("undefined" != typeof this.zeroLineIndex ? this.zeroLineIndex : 0) ? (this.ctx.lineWidth = this.options.gridLines.zeroLineWidth, this.ctx.strokeStyle = this.options.gridLines.zeroLineColor, e = !0) : e && (this.ctx.lineWidth = this.options.gridLines.lineWidth, this.ctx.strokeStyle = this.options.gridLines.color, e = !1), o += i.aliasPixel(this.ctx.lineWidth), this.ctx.beginPath(), this.options.gridLines.drawTicks && (this.ctx.moveTo(m, o), this.ctx.lineTo(f, o)), this.options.gridLines.drawOnChartArea && (this.ctx.moveTo(t.left, o), this.ctx.lineTo(t.right, o)), this.ctx.stroke()), this.options.ticks.display) {
                                        var n, r = this.getPixelForTick(s, this.options.gridLines.offsetGridLines);
                                        this.ctx.save(), "left" === this.options.position ? this.options.ticks.mirror ? (n = this.right + this.options.ticks.padding, this.ctx.textAlign = "left") : (n = this.right - this.options.ticks.padding, this.ctx.textAlign = "right") : this.options.ticks.mirror ? (n = this.left - this.options.ticks.padding, this.ctx.textAlign = "right") : (n = this.left + this.options.ticks.padding, this.ctx.textAlign = "left"), this.ctx.translate(n, r), this.ctx.rotate(-1 * i.toRadians(this.labelRotation)), this.ctx.font = h, this.ctx.textBaseline = "middle", this.ctx.fillText(a, 0, 0), this.ctx.restore()
                                    }
                                }
                            }, this), this.options.scaleLabel.display) {
                            s = "left" === this.options.position ? this.left + this.options.scaleLabel.fontSize / 2 : this.right - this.options.scaleLabel.fontSize / 2, o = this.top + (this.bottom - this.top) / 2;
                            var p = "left" === this.options.position ? -.5 * Math.PI : .5 * Math.PI;
                            this.ctx.save(), this.ctx.translate(s, o), this.ctx.rotate(p), this.ctx.textAlign = "center", this.ctx.fillStyle = this.options.scaleLabel.fontColor, this.ctx.font = i.fontString(this.options.scaleLabel.fontSize, this.options.scaleLabel.fontStyle, this.options.scaleLabel.fontFamily), this.ctx.textBaseline = "middle", this.ctx.fillText(this.options.scaleLabel.labelString, 0, 0), this.ctx.restore()
                        }
                    }
                }
            }
        ...
        e.scaleService = {
            constructors: {}, defaults: {}, registerScaleType: function (t, e, a) {
                this.constructors[t] = e, this.defaults[t] = i.clone(a)
        ...
        e.defaults.global.title = {
            ...
            draw: function () {
                if (this.options.display) {
                    var t, e, a = this.ctx;
                    if (this.isHorizontal())this.options.display && (a.textAlign = "center", a.textBaseline = "middle", a.fillStyle = this.options.fontColor, a.font = i.fontString(this.options.fontSize, this.options.fontStyle, this.options.fontFamily), t = this.left + (this.right - this.left) / 2, e = this.top + (this.bottom - this.top) / 2, a.fillText(this.options.text, t, e)); else if (this.options.display) {
                        ...
                        var s = "left" == this.options.position ? -.5 * Math.PI : .5 * Math.PI;
                        a.save(), a.translate(t, e), a.rotate(s), a.textAlign = "center", a.fillStyle = this.options.fontColor, a.font = i.fontString(this.options.fontSize, this.options.fontStyle, this.options.fontFamily), a.textBaseline = "middle", a.fillText(this.options.text, 0, 0), a.restore()
                    }
                }
            }
        })
        ...
        "use strict";
        function t(t, e) {
            return e && (a.isArray(e) ? t = t.concat(e) : t.push(e)), t
        }

        var e = this, i = e.Chart, a = i.helpers;
        i.defaults.global.tooltips = {
            ...
            initialize: function () {
                ...
                var e = this._options.tooltips.callbacks.beforeTitle.apply(this, arguments), i = this._options.tooltips.callbacks.title.apply(this, arguments), a = this._options.tooltips.callbacks.afterTitle.apply(this, arguments), s = [];
                return s = t(s, e), s = t(s, i), s = t(s, a)
                ...
                return a.each(t, function (t) {
                    var a = this._options.tooltips.callbacks.beforeLabel.call(this, t, e) || "", s = this._options.tooltips.callbacks.label.call(this, t, e) || "", o = this._options.tooltips.callbacks.afterLabel.call(this, t, e) || "";
                    i.push(a + s + o)
                }, this), i
                ...
                var e = this._options.tooltips.callbacks.beforeFooter.apply(this, arguments), i = this._options.tooltips.callbacks.footer.apply(this, arguments), a = this._options.tooltips.callbacks.afterFooter.apply(this, arguments), s = [];
                return s = t(s, e), s = t(s, i), s = t(s, a)
                ...
                for (var s = 0, o = 0, n = 0; n < e.length; n++)s += e[n], o += i[n];
                return {x: Math.round(s / e.length), y: Math.round(o / e.length)}
            }, update: function (t) {
                if (this._active.length) {
                    this._model.opacity = 1;
                    var e, i = this._active[0], s = [], o = [];
                    if ("single" === this._options.tooltips.mode) {
                        var n = i._yScale || i._scale;
                        o.push({
                            xLabel: i._xScale ? i._xScale.getLabelForIndex(i._index, i._datasetIndex) : "",
                            yLabel: n ? n.getLabelForIndex(i._index, i._datasetIndex) : "",
                            index: i._index,
                            datasetIndex: i._datasetIndex
                        }), e = this.getAveragePosition(this._active)
                    } else a.each(this._data.datasets, function (t, e) {
                        if (a.isDatasetVisible(t)) {
                            var s = t.metaData[i._index];
                            if (s) {
                                var n = i._yScale || i._scale;
                                o.push({
                    ...
                    }), a.each(this._active, function (t) {
                        t && s.push({borderColor: t._view.borderColor, backgroundColor: t._view.backgroundColor})
                    }, this), e = this.getAveragePosition(this._active), e.y = this._active[0]._yScale.getPixelForDecimal(.5);
                    a.extend(this._model, {
                        ...
                        x: Math.round(e.x),
                        y: Math.round(e.y),
                        caretPadding: a.getValueOrDefault(e.padding, 2),
                        labelColors: s
                    });
                    var r = this.getTooltipSize(this._model);
                    this.determineAlignment(r), a.extend(this._model, this.getBackgroundPoint(this._model, r))
                ...
                var e = this._chart.ctx, i = {
                    height: 2 * t.yPadding,
                    width: 0
                }, s = t.body.length + t.beforeBody.length + t.afterBody.length;
                return i.height += t.title.length * t.titleFontSize, i.height += (t.title.length - 1) * t.titleSpacing, i.height += t.title.length ? t.titleMarginBottom : 0, i.height += s * t.bodyFontSize, i.height += s ? (s - 1) * t.bodySpacing : 0, i.height += t.footer.length ? t.footerMarginTop : 0, i.height += t.footer.length * t.footerFontSize, i.height += t.footer.length ? (t.footer.length - 1) * t.footerSpacing : 0, e.font = a.fontString(t.titleFontSize, t._titleFontStyle, t._titleFontFamily), a.each(t.title, function (t) {
                    i.width = Math.max(i.width, e.measureText(t).width)
                }), e.font = a.fontString(t.bodyFontSize, t._bodyFontStyle, t._bodyFontFamily), a.each(t.beforeBody.concat(t.afterBody), function (t) {
                    i.width = Math.max(i.width, e.measureText(t).width)
                }, this), a.each(t.body, function (a) {
                    i.width = Math.max(i.width, e.measureText(a).width + ("single" !== this._options.tooltips.mode ? t.bodyFontSize + 2 : 0))
                }, this), e.font = a.fontString(t.footerFontSize, t._footerFontStyle, t._footerFontFamily), a.each(t.footer, function (t) {
                    i.width = Math.max(i.width, e.measureText(t).width)
                ...
                var e, i, a = this, s = (this._chartInstance.chartArea.left + this._chartInstance.chartArea.right) / 2;
                ...
                }), e(this._model.x) ? this._model.xAlign = "left" : i(this._model.x) && (this._model.xAlign = "right")
            ...
            }, drawCaret: function (t, e, i, s) {
                var o, n, r, h, l, c, d = this._view, u = this._chart.ctx;
                "center" === d.yAlign ? ("left" === d.xAlign ? (o = t.x, n = o - d.caretSize, r = o) : (o = t.x + e.width, n = o + d.caretSize, r = o), l = t.y + e.height / 2, h = l - d.caretSize, c = l + d.caretSize) : ("left" === d.xAlign ? (o = t.x + d.cornerRadius, n = o + d.caretSize, r = n + d.caretSize) : "right" === d.xAlign ? (o = t.x + e.width - d.cornerRadius, n = o - d.caretSize, r = n - d.caretSize) : (n = t.x + e.width / 2, o = n - d.caretSize, r = n + d.caretSize), "top" === d.yAlign ? (h = t.y, l = h - d.caretSize, c = h) : (h = t.y + e.height, l = h + d.caretSize, c = h)), u.fillStyle = a.color(d.backgroundColor).alpha(i).rgbString(), u.beginPath(), u.moveTo(o, h), u.lineTo(n, l), u.lineTo(r, c), u.closePath(), u.fill()
            }, drawTitle: function (t, e, i, s) {
                e.title.length && (i.textAlign = e._titleAlign, i.textBaseline = "top", i.fillStyle = a.color(e.titleColor).alpha(s).rgbString(), i.font = a.fontString(e.titleFontSize, e._titleFontStyle, e._titleFontFamily), a.each(e.title, function (a, s) {
                    i.fillText(a, t.x, t.y), t.y += e.titleFontSize + e.titleSpacing, s + 1 === e.title.length && (t.y += e.titleMarginBottom - e.titleSpacing)
                }, this))
            }, drawBody: function (t, e, i, s) {
                i.textAlign = e._bodyAlign, i.textBaseline = "top", i.fillStyle = a.color(e.bodyColor).alpha(s).rgbString(), i.font = a.fontString(e.bodyFontSize, e._bodyFontStyle, e._bodyFontFamily), a.each(e.beforeBody, function (a) {
                    i.fillText(a, t.x, t.y), t.y += e.bodyFontSize + e.bodySpacing
                }), a.each(e.body, function (o, n) {
                ...
                }, this), a.each(e.afterBody, function (a) {
                    i.fillText(a, t.x, t.y), t.y += e.bodyFontSize
                }), t.y -= e.bodySpacing
            }, drawFooter: function (t, e, i, s) {
                e.footer.length && (t.y += e.footerMarginTop, i.textAlign = e._footerAlign, i.textBaseline = "top", i.fillStyle = a.color(e.footerColor).alpha(s).rgbString(), i.font = a.fontString(e.footerFontSize, e._footerFontStyle, e._footerFontFamily), a.each(e.footer, function (a) {
                    i.fillText(a, t.x, t.y), t.y += e.footerFontSize + e.footerSpacing
                }, this))
            }, draw: function () {
                var t = this._chart.ctx, e = this._view;
                if (0 !== e.opacity) {
                    var i = e.caretPadding, s = this.getTooltipSize(e), o = {
                        x: e.x,
                        y: e.y
                    }, n = Math.abs(e.opacity < .001) ? 0 : e.opacity;
                    this._options.tooltips.enabled && (t.fillStyle = a.color(e.backgroundColor).alpha(n).rgbString(), a.drawRoundedRectangle(t, o.x, o.y, s.width, s.height, e.cornerRadius), t.fill(), this.drawCaret(o, s, n, i), o.x += e.xPadding, o.y += e.yPadding, this.drawTitle(o, e, t, n), this.drawBody(o, e, t, n), this.drawFooter(o, e, t, n))
                }
            }
        })
    }.call(this), function () {
        ...
        e.defaults.bar = {
            ...
            initialize: function (t, i) {
                ...
                this.updateElement(i, t, !0, a), this.getDataset().metaData.splice(t, 0, i)
            }, update: function (t) {
                var e = this.getBarCount();
                i.each(this.getDataset().metaData, function (i, a) {
                    this.updateElement(i, a, t, e)
                }, this)
            }, updateElement: function (t, e, a, s) {
                var o, n = this.getScaleForId(this.getDataset().xAxisID), r = this.getScaleForId(this.getDataset().yAxisID);
                o = r.min < 0 && r.max < 0 ? r.getPixelForValue(r.max) : r.min > 0 && r.max > 0 ? r.getPixelForValue(r.min) : r.getPixelForValue(0), i.extend(t, {
                    _chart: this.chart.chart,
                    _xScale: n,
                    _yScale: r,
                    _datasetIndex: this.index,
                ...
                var a = (this.getScaleForId(this.getDataset().xAxisID), this.getScaleForId(this.getDataset().yAxisID)), s = 0;
                if (a.options.stacked) {
                    var o = this.chart.data.datasets[t].data[e];
                    if (0 > o)for (var n = 0; t > n; n++) {
                        var r = this.chart.data.datasets[n];
                        i.isDatasetVisible(r) && r.yAxisID === a.id && (s += r.data[e] < 0 ? r.data[e] : 0)
                    } else for (var h = 0; t > h; h++) {
                        var l = this.chart.data.datasets[h];
                        i.isDatasetVisible(l) && l.yAxisID === a.id && (s += l.data[e] > 0 ? l.data[e] : 0)
                    }
                ...
                var t = this.getScaleForId(this.getDataset().xAxisID), e = (this.getScaleForId(this.getDataset().yAxisID), this.getBarCount()), i = function () {
                    ...
                    return e
                }.call(this), a = i * t.options.categoryPercentage, s = (i - i * t.options.categoryPercentage) / 2, o = a / e, n = o * t.options.barPercentage, r = o - o * t.options.barPercentage;
                return {
                    datasetCount: e,
                    tickWidth: i,
                    categoryWidth: a,
                ...
                var t = this.getScaleForId(this.getDataset().xAxisID), e = this.getRuler();
                return t.options.stacked ? e.categoryWidth : e.barWidth
            }, getBarIndex: function (t) {
                for (var e = 0, a = 0; t > a; ++a)i.isDatasetVisible(this.chart.data.datasets[a]) && this.chart.data.datasets[a].bar && ++e;
                return e
            }, calculateBarX: function (t, e) {
                var i = (this.getScaleForId(this.getDataset().yAxisID), this.getScaleForId(this.getDataset().xAxisID)), a = this.getBarIndex(e), s = this.getRuler(), o = i.getPixelForValue(null, t, e, this.chart.isCombo);
                ...
                var a = (this.getScaleForId(this.getDataset().xAxisID), this.getScaleForId(this.getDataset().yAxisID)), s = this.getDataset().data[t];
                if (a.options.stacked) {
                    for (var o = 0, n = 0, r = 0; e > r; r++) {
                        var h = this.chart.data.datasets[r];
                        i.isDatasetVisible(h) && (h.data[t] < 0 ? n += h.data[t] || 0 : o += h.data[t] || 0)
                    }
                ...
                var e = this.chart.data.datasets[t._datasetIndex], a = t._index;
                t._model.backgroundColor = t.custom && t.custom.hoverBackgroundColor ? t.custom.hoverBackgroundColor : i.getValueAtIndexOrDefault(e.hoverBackgroundColor, a, i.color(t._model.backgroundColor).saturate(.5).darken(.1).rgbString()), t._model.borderColor = t.custom && t.custom.hoverBorderColor ? t.custom.hoverBorderColor : i.getValueAtIndexOrDefault(e.hoverBorderColor, a, i.color(t._model.borderColor).saturate(.5).darken(.1).rgbString()), t._model.borderWidth = t.custom && t.custom.hoverBorderWidth ? t.custom.hoverBorderWidth : i.getValueAtIndexOrDefault(e.hoverBorderWidth, a, t._model.borderWidth)
        ...
        e.defaults.bubble = {
            ...
            addElements: function () {
                ...
                this.getDataset().metaData = this.getDataset().metaData || [];
                var i = new e.elements.Point({_chart: this.chart.chart, _datasetIndex: this.index, _index: t});
                this.updateElement(i, t, !0), this.getDataset().metaData.splice(t, 0, i)
            }, update: function (t) {
                var e, a = this.getDataset().metaData, s = this.getScaleForId(this.getDataset().yAxisID);
                this.getScaleForId(this.getDataset().xAxisID);
                e = s.min < 0 && s.max < 0 ? s.getPixelForValue(s.max) : s.min > 0 && s.max > 0 ? s.getPixelForValue(s.min) : s.getPixelForValue(0), i.each(a, function (e, i) {
                    this.updateElement(e, i, t)
                }, this)
            }, updateElement: function (t, e, a) {
                var s, o = this.getScaleForId(this.getDataset().yAxisID), n = this.getScaleForId(this.getDataset().xAxisID);
                s = o.min < 0 && o.max < 0 ? o.getPixelForValue(o.max) : o.min > 0 && o.max > 0 ? o.getPixelForValue(o.min) : o.getPixelForValue(0), i.extend(t, {
                    _chart: this.chart.chart,
                    _xScale: n,
                    _yScale: o,
                    _datasetIndex: this.index,
                    _index: e,
                    _model: {
                        x: a ? n.getPixelForDecimal(.5) : n.getPixelForValue(this.getDataset().data[e], e, this.index, this.chart.isCombo),
                        y: a ? s : o.getPixelForValue(this.getDataset().data[e], e, this.index),
                        radius: a ? 0 : t.custom && t.custom.radius ? t.custom.radius : this.getRadius(this.getDataset().data[e]),
        ...
        e.defaults.doughnut = {
            ...
            legendCallback: function (t) {
                var e = [];
                if (e.push('<ul class="' + t.id + '-legend">'), t.data.datasets.length)for (var i = 0; i < t.data.datasets[0].data.length; ++i)e.push('<li><span style="background-color:' + t.data.datasets[0].backgroundColor[i] + '">'), t.data.labels[i] && e.push(t.data.labels[i]), e.push("</span></li>");
                return e.push("</ul>"), e.join("")
            },
            legend: {
                labels: {
        ...
        }, e.defaults.pie = i.clone(e.defaults.doughnut), i.extend(e.defaults.pie, {cutoutPercentage: 0}), e.controllers.doughnut = e.controllers.pie = e.DatasetController.extend({
            linkScales: function () {
            }, addElements: function () {
                this.getDataset().metaData = this.getDataset().metaData || [], i.each(this.getDataset().data, function (t, i) {
            ...
            }, addElementAndReset: function (t, a) {
                this.getDataset().metaData = this.getDataset().metaData || [];
                var s = new e.elements.Arc({_chart: this.chart.chart, _datasetIndex: this.index, _index: t});
                a && i.isArray(this.getDataset().backgroundColor) && this.getDataset().backgroundColor.splice(t, 0, a), this.updateElement(s, t, !0), this.getDataset().metaData.splice(t, 0, s)
            }, getVisibleDatasetCount: function () {
                return i.where(this.chart.data.datasets, function (t) {
                    return i.isDatasetVisible(t)
                }).length
            }, getRingIndex: function (t) {
                for (var e = 0, a = 0; t > a; ++a)i.isDatasetVisible(this.chart.data.datasets[a]) && ++e;
                return e
            }, update: function (t) {
                ...
                var s = (this.chart.chartArea.left + this.chart.chartArea.right) / 2, o = (this.chart.chartArea.top + this.chart.chartArea.bottom) / 2, n = {
                    x: s,
                    y: o,
                ...
                }), a || (0 === e ? t._model.startAngle = Math.PI * -.5 : t._model.startAngle = this.getDataset().metaData[e - 1]._model.endAngle, t._model.endAngle = t._model.startAngle + t._model.circumference, e < this.getDataset().data.length - 1 && (this.getDataset().metaData[e + 1]._model.startAngle = t._model.endAngle)), t.pivot()
            }, draw: function (t) {
                var e = t || 1;
                i.each(this.getDataset().metaData, function (t, i) {
                    t.transition(e).draw()
        ...
        e.defaults.line = {
            ...
            addElements: function () {
                ...
                var e, a = this.getDataset().metaDataset, s = this.getDataset().metaData, o = this.getScaleForId(this.getDataset().yAxisID);
                this.getScaleForId(this.getDataset().xAxisID);
                e = o.min < 0 && o.max < 0 ? o.getPixelForValue(o.max) : o.min > 0 && o.max > 0 ? o.getPixelForValue(o.min) : o.getPixelForValue(0), i.extend(a, {
                    _scale: o,
                    _datasetIndex: this.index,
                    _children: s,
                    _model: {
                        tension: a.custom && a.custom.tension ? a.custom.tension : i.getValueOrDefault(this.getDataset().tension, this.chart.options.elements.line.tension),
                ...
                }), a.pivot(), i.each(s, function (e, i) {
                    this.updateElement(e, i, t)
                }, this), this.updateBezierControlPoints()
            }, getPointBackgroundColor: function (t, e) {
                var a = this.chart.options.elements.point.backgroundColor, s = this.getDataset();
                return t.custom && t.custom.backgroundColor ? a = t.custom.backgroundColor : s.pointBackgroundColor ? a = i.getValueAtIndexOrDefault(s.pointBackgroundColor, e, a) : s.backgroundColor && (a = s.backgroundColor), a
            }, getPointBorderColor: function (t, e) {
                var a = this.chart.options.elements.point.borderColor, s = this.getDataset();
                return t.custom && t.custom.borderColor ? a = t.custom.borderColor : s.pointBorderColor ? a = i.getValueAtIndexOrDefault(this.getDataset().pointBorderColor, e, a) : s.borderColor && (a = s.borderColor), a
            }, getPointBorderWidth: function (t, e) {
                var a = this.chart.options.elements.point.borderWidth, s = this.getDataset();
                return t.custom && void 0 !== t.custom.borderWidth ? a = t.custom.borderWidth : void 0 !== s.pointBorderWidth ? a = i.getValueAtIndexOrDefault(s.pointBorderWidth, e, a) : void 0 !== s.borderWidth && (a = s.borderWidth), a
            }, updateElement: function (t, e, a) {
                var s, o = this.getScaleForId(this.getDataset().yAxisID), n = this.getScaleForId(this.getDataset().xAxisID);
                s = o.min < 0 && o.max < 0 ? o.getPixelForValue(o.max) : o.min > 0 && o.max > 0 ? o.getPixelForValue(o.min) : o.getPixelForValue(0), i.extend(t, {
                    _chart: this.chart.chart,
                    ...
                    _index: e,
                    _model: {
                        x: n.getPixelForValue(this.getDataset().data[e], e, this.index, this.chart.isCombo),
                        y: a ? s : this.calculatePointY(this.getDataset().data[e], e, this.index, this.chart.isCombo),
            ...
            }, calculatePointY: function (t, e, a, s) {
                var o = (this.getScaleForId(this.getDataset().xAxisID), this.getScaleForId(this.getDataset().yAxisID));
                if (o.options.stacked) {
                    for (var n = 0, r = 0, h = this.chart.data.datasets.length - 1; h > a; h--) {
                        var l = this.chart.data.datasets[h];
                        i.isDatasetVisible(l) && (l.data[e] < 0 ? r += l.data[e] || 0 : n += l.data[e] || 0)
                    }
                ...
                i.each(this.getDataset().metaData, function (t, e) {
                    var a = i.splineCurve(i.previousItem(this.getDataset().metaData, e)._model, t._model, i.nextItem(this.getDataset().metaData, e)._model, t._model.tension);
        ...
        e.defaults.polarArea = {
            ...
            linkScales: function () {
                ...
                this.getDataset().metaData = this.getDataset().metaData || [];
                var i = new e.elements.Arc({_chart: this.chart.chart, _datasetIndex: this.index, _index: t});
                this.updateElement(i, t, !0), this.getDataset().metaData.splice(t, 0, i)
            }, getVisibleDatasetCount: function () {
                return i.where(this.chart.data.datasets, function (t) {
                    return i.isDatasetVisible(t)
                ...
                for (var s = this.calculateCircumference(this.getDataset().data[e]), o = (this.chart.chartArea.left + this.chart.chartArea.right) / 2, n = (this.chart.chartArea.top + this.chart.chartArea.bottom) / 2, r = 0, h = 0; e > h; ++h)isNaN(this.getDataset().data[h]) || ++r;
                var l = -.5 * Math.PI + s * r, c = l + s, d = {
                    x: o,
                    y: n,
                    innerRadius: 0,
                ...
                var e = this.chart.data.datasets[t._datasetIndex], a = t._index;
                t._model.backgroundColor = t.custom && t.custom.hoverBackgroundColor ? t.custom.hoverBackgroundColor : i.getValueAtIndexOrDefault(e.hoverBackgroundColor, a, i.color(t._model.backgroundColor).saturate(.5).darken(.1).rgbString()), t._model.borderColor = t.custom && t.custom.hoverBorderColor ? t.custom.hoverBorderColor : i.getValueAtIndexOrDefault(e.hoverBorderColor, a, i.color(t._model.borderColor).saturate(.5).darken(.1).rgbString()), t._model.borderWidth = t.custom && t.custom.hoverBorderWidth ? t.custom.hoverBorderWidth : i.getValueAtIndexOrDefault(e.borderWidth, a, t._model.borderWidth)
            }, removeHoverStyle: function (t) {
                var e = (this.chart.data.datasets[t._datasetIndex], t._index);
                t._model.backgroundColor = t.custom && t.custom.backgroundColor ? t.custom.backgroundColor : i.getValueAtIndexOrDefault(this.getDataset().backgroundColor, e, this.chart.options.elements.arc.backgroundColor), t._model.borderColor = t.custom && t.custom.borderColor ? t.custom.borderColor : i.getValueAtIndexOrDefault(this.getDataset().borderColor, e, this.chart.options.elements.arc.borderColor), t._model.borderWidth = t.custom && t.custom.borderWidth ? t.custom.borderWidth : i.getValueAtIndexOrDefault(this.getDataset().borderWidth, e, this.chart.options.elements.arc.borderWidth)
            }, calculateCircumference: function (t) {
        ...
        e.defaults.radar = {
            ...
            linkScales: function () {
                ...
                var e, a = (this.getDataset().metaDataset, this.getDataset().metaData), s = this.chart.scale;
                e = s.min < 0 && s.max < 0 ? s.getPointPositionForValue(0, s.max) : s.min > 0 && s.max > 0 ? s.getPointPositionForValue(0, s.min) : s.getPointPositionForValue(0, 0), i.extend(this.getDataset().metaDataset, {
                    _datasetIndex: this.index,
                    _children: this.getDataset().metaData,
                    _model: {
                        tension: i.getValueOrDefault(this.getDataset().tension, this.chart.options.elements.line.tension),
                ...
                }), this.getDataset().metaDataset.pivot(), i.each(a, function (e, i) {
                    this.updateElement(e, i, t)
                }, this), this.updateBezierControlPoints()
            }, updateElement: function (t, e, a) {
                var s = this.chart.scale.getPointPositionForValue(e, this.getDataset().data[e]);
                i.extend(t, {
                    _datasetIndex: this.index,
                    _index: e,
                    _scale: this.chart.scale,
                    _model: {
                        ...
                        tension: t.custom && t.custom.tension ? t.custom.tension : i.getValueOrDefault(this.getDataset().tension, this.chart.options.elements.line.tension),
                        radius: t.custom && t.custom.radius ? t.custom.pointRadius : i.getValueAtIndexOrDefault(this.getDataset().pointRadius, e, this.chart.options.elements.point.radius),
                ...
                i.each(this.getDataset().metaData, function (t, e) {
                    var a = i.splineCurve(i.previousItem(this.getDataset().metaData, e, !0)._model, t._model, i.nextItem(this.getDataset().metaData, e, !0)._model, t._model.tension);
                    t._model.controlPointPreviousX = Math.max(Math.min(a.previous.x, this.chart.chartArea.right), this.chart.chartArea.left), t._model.controlPointPreviousY = Math.max(Math.min(a.previous.y, this.chart.chartArea.bottom), this.chart.chartArea.top), t._model.controlPointNextX = Math.max(Math.min(a.next.x, this.chart.chartArea.right), this.chart.chartArea.left), t._model.controlPointNextY = Math.max(Math.min(a.next.y, this.chart.chartArea.bottom), this.chart.chartArea.top), t.pivot()
                }, this)
            }, draw: function (t) {
                var e = t || 1;
                ...
                var e = this.chart.data.datasets[t._datasetIndex], a = t._index;
                t._model.radius = t.custom && t.custom.radius ? t.custom.radius : i.getValueAtIndexOrDefault(e.pointHoverRadius, a, this.chart.options.elements.point.hoverRadius), t._model.backgroundColor = t.custom && t.custom.hoverBackgroundColor ? t.custom.hoverBackgroundColor : i.getValueAtIndexOrDefault(e.pointHoverBackgroundColor, a, i.color(t._model.backgroundColor).saturate(.5).darken(.1).rgbString()), t._model.borderColor = t.custom && t.custom.hoverBorderColor ? t.custom.hoverBorderColor : i.getValueAtIndexOrDefault(e.pointHoverBorderColor, a, i.color(t._model.borderColor).saturate(.5).darken(.1).rgbString()), t._model.borderWidth = t.custom && t.custom.hoverBorderWidth ? t.custom.hoverBorderWidth : i.getValueAtIndexOrDefault(e.pointBorderWidth, a, t._model.borderWidth)
            }, removeHoverStyle: function (t) {
                var e = (this.chart.data.datasets[t._datasetIndex], t._index);
        ...
        "use strict";
        var t = this, e = t.Chart, i = (e.helpers, {position: "bottom"}), a = e.Scale.extend({
            buildTicks: function (t) {
                ...
                if (this.isHorizontal()) {
                    var s = this.width - (this.paddingLeft + this.paddingRight), o = s / Math.max(this.chart.data.labels.length - (this.options.gridLines.offsetGridLines ? 0 : 1), 1), n = o * e + this.paddingLeft;
                    return this.options.gridLines.offsetGridLines && a && (n += o / 2), this.left + Math.round(n)
                }
                var r = this.height - (this.paddingTop + this.paddingBottom), h = r / Math.max(this.chart.data.labels.length - (this.options.gridLines.offsetGridLines ? 0 : 1), 1), l = h * e + this.paddingTop;
                return this.options.gridLines.offsetGridLines && a && (l += h / 2), this.top + Math.round(l)
            }
        });
        e.scaleService.registerScaleType("category", a, i)
    }.call(this), function () {
        "use strict";
        var t = this, e = t.Chart, i = e.helpers, a = {
            position: "left", ticks: {
                callback: function (t, e, a) {
                    var s = a[1] - a[0];
                    Math.abs(s) > 1 && t !== Math.floor(t) && (s = t - Math.floor(t));
                    var o = i.log10(Math.abs(s)), n = "";
                    if (0 !== t) {
            ...
            determineDataLimits: function () {
                if (this.min = null, this.max = null, this.options.stacked) {
                    ...
                    i.each(this.chart.data.datasets, function (e) {
                        void 0 === t[e.type] && (t[e.type] = {positiveValues: [], negativeValues: []});
                        var a = t[e.type].positiveValues, s = t[e.type].negativeValues;
                        i.isDatasetVisible(e) && (this.isHorizontal() ? e.xAxisID === this.id : e.yAxisID === this.id) && i.each(e.data, function (t, e) {
                            var i = +this.getRightValue(t);
                            isNaN(i) || (a[e] = a[e] || 0, s[e] = s[e] || 0, this.options.relativePoints ? a[e] = 100 : 0 > i ? s[e] += i : a[e] += i)
                        }, this)
                    }, this), i.each(t, function (t) {
                        var e = t.positiveValues.concat(t.negativeValues), a = i.min(e), s = i.max(e);
                ...
                if (this.options.ticks.beginAtZero) {
                    var e = i.sign(this.min), a = i.sign(this.max);
                    0 > e && 0 > a ? this.max = 0 : e > 0 && a > 0 && (this.min = 0)
                }
                ...
                var e = i.niceNum(this.max - this.min, !1), a = i.niceNum(e / (t - 1), !0), s = Math.floor(this.min / a) * a, o = Math.ceil(this.max / a) * a, n = Math.ceil((o - s) / a);
                this.ticks.push(void 0 !== this.options.ticks.min ? this.options.ticks.min : s);
                for (var r = 1; n > r; ++r)this.ticks.push(s + r * a);
                this.ticks.push(void 0 !== this.options.ticks.max ? this.options.ticks.max : o), ("left" == this.options.position || "right" == this.options.position) && this.ticks.reverse(), this.max = i.max(this.ticks), this.min = i.min(this.ticks), this.ticksAsNumbers = this.ticks.slice(), this.options.ticks.reverse ? (this.ticks.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), this.zeroLineIndex = this.ticks.indexOf(0)
            }, getLabelForIndex: function (t, e) {
                return +this.getRightValue(this.chart.data.datasets[e].data[t])
            }, getPixelForValue: function (t, e, i, a) {
                var s, o = +this.getRightValue(t), n = this.end - this.start;
                if (this.isHorizontal()) {
        ...
        e.scaleService.registerScaleType("linear", s, a)
    }.call(this), function () {
        "use strict";
        var t = this, e = t.Chart, i = e.helpers, a = {
            position: "left", ticks: {
                callback: function (t, i, a) {
                    var s = t / Math.pow(10, Math.floor(e.helpers.log10(t)));
                    return 1 === s || 2 === s || 5 === s || 0 === i || i === a.length - 1 ? t.toExponential() : ""
                }
            }
        }, s = e.Scale.extend({
            determineDataLimits: function () {
                if (this.min = null, this.max = null, this.options.stacked) {
                    var t = {};
                    i.each(this.chart.data.datasets, function (e) {
                        i.isDatasetVisible(e) && (this.isHorizontal() ? e.xAxisID === this.id : e.yAxisID === this.id) && (void 0 === t[e.type] && (t[e.type] = []), i.each(e.data, function (i, a) {
                            var s = t[e.type], o = +this.getRightValue(i);
                            isNaN(o) || (s[a] = s[a] || 0, this.options.relativePoints ? s[a] = 100 : s[a] += o)
                        }, this))
                    }, this), i.each(t, function (t) {
                        var e = i.min(t), a = i.max(t);
                        this.min = null === this.min ? e : Math.min(this.min, e), this.max = null === this.max ? a : Math.max(this.max, a)
                    }, this)
                } else i.each(this.chart.data.datasets, function (t) {
                    i.isDatasetVisible(t) && (this.isHorizontal() ? t.xAxisID === this.id : t.yAxisID === this.id) && i.each(t.data, function (t, e) {
                        var i = +this.getRightValue(t);
                ...
                for (var t = void 0 !== this.options.ticks.min ? this.options.ticks.min : Math.pow(10, Math.floor(i.log10(this.min))); t < this.max;) {
                    ...
                    var e = Math.floor(i.log10(t)), a = Math.floor(t / Math.pow(10, e)) + 1;
                    10 === a && (a = 1, ++e), t = a * Math.pow(10, e)
                }
                var s = void 0 !== this.options.ticks.max ? this.options.ticks.max : t;
                this.tickValues.push(s), ("left" == this.options.position || "right" == this.options.position) && this.tickValues.reverse(), this.max = i.max(this.tickValues), this.min = i.min(this.tickValues), this.options.ticks.reverse ? (this.tickValues.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), this.ticks = this.tickValues.slice()
            }, getLabelForIndex: function (t, e) {
                return +this.getRightValue(this.chart.data.datasets[e].data[t])
            }, getPixelForTick: function (t, e) {
                return this.getPixelForValue(this.tickValues[t], null, null, e)
            }, getPixelForValue: function (t, e, a, s) {
                var o, n = +this.getRightValue(t), r = i.log10(this.end) - i.log10(this.start);
                if (this.isHorizontal()) {
                    if (0 !== n) {
                        var h = this.width - (this.paddingLeft + this.paddingRight);
                        return o = this.left + h / r * (i.log10(n) - i.log10(this.start)), o + this.paddingLeft
                    }
                    o = this.left + this.paddingLeft
                } else {
                    if (0 !== n) {
                        var l = this.height - (this.paddingTop + this.paddingBottom);
                        return this.bottom - this.paddingBottom - l / r * (i.log10(n) - i.log10(this.start))
                    }
                    o = this.top + this.paddingTop
                }
            }
        });
        e.scaleService.registerScaleType("logarithmic", s, a)
    }.call(this), function () {
        "use strict";
        var t = this, e = t.Chart, i = e.helpers, a = {
            display: !0,
            ...
            pointLabels: {fontFamily: "'Arial'", fontStyle: "normal", fontSize: 10, fontColor: "#666"}
        }, s = e.Scale.extend({
            getValueCount: function () {
                ...
                if (this.min = null, this.max = null, i.each(this.chart.data.datasets, function (t) {
                    ...
                    var t = i.sign(this.min), e = i.sign(this.max);
                    0 > t && 0 > e ? this.max = 0 : t > 0 && e > 0 && (this.min = 0)
                }
            }, buildTicks: function () {
                this.ticks = [];
                ...
                t = Math.max(2, t);
                for (var e = i.niceNum(this.max - this.min, !1), a = i.niceNum(e / (t - 1), !0), s = Math.floor(this.min / a) * a, o = Math.ceil(this.max / a) * a, n = s; o >= n; n += a)this.ticks.push(n);
                this.max = i.max(this.ticks), this.min = i.min(this.ticks), this.options.ticks.reverse ? (this.ticks.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), this.zeroLineIndex = this.ticks.indexOf(0)
            }, getLabelForIndex: function (t, e) {
                return +this.getRightValue(this.chart.data.datasets[e].data[t]);
            }, getCircumference: function () {
                return 2 * Math.PI / this.getValueCount()
            }, fit: function () {
                var t, e, a, s, o, n, r, h, l, c, d, u, g = i.min([this.height / 2 - this.options.pointLabels.fontSize - 5, this.width / 2]), m = this.width, f = 0;
                for (this.ctx.font = i.fontString(this.options.pointLabels.fontSize, this.options.pointLabels.fontStyle, this.options.pointLabels.fontFamily), e = 0; e < this.getValueCount(); e++)t = this.getPointPosition(e, g), a = this.ctx.measureText(this.options.ticks.callback(this.chart.data.labels[e])).width + 5, 0 === e || e === this.getValueCount() / 2 ? (s = a / 2, t.x + s > m && (m = t.x + s, o = e), t.x - s < f && (f = t.x - s, r = e)) : e < this.getValueCount() / 2 ? t.x + a > m && (m = t.x + a, o = e) : e > this.getValueCount() / 2 && t.x - a < f && (f = t.x - a, r = e);
                l = f, c = Math.ceil(m - this.width), n = this.getIndexAngle(o), h = this.getIndexAngle(r), d = c / Math.sin(n + Math.PI / 2), u = l / Math.sin(h + Math.PI / 2), d = i.isNumber(d) ? d : 0, u = i.isNumber(u) ? u : 0, this.drawingArea = Math.round(g - (u + d) / 2), this.setCenterPoint(u, d)
                ...
                if (this.options.display) {
                    var t = this.ctx;
                    if (i.each(this.ticks, function (e, a) {
                            if (a > 0 || this.options.reverse) {
                                var s = this.getDistanceFromCenterForValue(this.ticks[a]), o = this.yCenter - s;
                                if (this.options.gridLines.display)if (t.strokeStyle = this.options.gridLines.color, t.lineWidth = this.options.gridLines.lineWidth, this.options.lineArc)t.beginPath(), t.arc(this.xCenter, this.yCenter, s, 0, 2 * Math.PI), t.closePath(), t.stroke(); else {
                                    t.beginPath();
                                    for (var n = 0; n < this.getValueCount(); n++) {
                                        var r = this.getPointPosition(n, this.getDistanceFromCenterForValue(this.ticks[a]));
                                ...
                                if (this.options.ticks.display) {
                                    if (t.font = i.fontString(this.options.ticks.fontSize, this.options.ticks.fontStyle, this.options.ticks.fontFamily), this.options.ticks.showLabelBackdrop) {
                                        ...
                                        t.fillStyle = this.options.ticks.backdropColor, t.fillRect(this.xCenter - h / 2 - this.options.ticks.backdropPaddingX, o - this.options.ticks.fontSize / 2 - this.options.ticks.backdropPaddingY, h + 2 * this.options.ticks.backdropPaddingX, this.options.ticks.fontSize + 2 * this.options.ticks.backdropPaddingY)
                                    }
                                    t.textAlign = "center", t.textBaseline = "middle", t.fillStyle = this.options.ticks.fontColor, t.fillText(e, this.xCenter, o)
                                }
                            }
                        ...
                        for (var e = this.getValueCount() - 1; e >= 0; e--) {
                            if (this.options.angleLines.display) {
                                var a = this.getPointPosition(e, this.getDistanceFromCenterForValue(this.options.reverse ? this.min : this.max));
                                t.beginPath(), t.moveTo(this.xCenter, this.yCenter), t.lineTo(a.x, a.y), t.stroke(), t.closePath()
                            }
                            var s = this.getPointPosition(e, this.getDistanceFromCenterForValue(this.options.reverse ? this.min : this.max) + 5);
                            ...
                            var o = this.chart.data.labels.length, n = this.chart.data.labels.length / 2, r = n / 2, h = r > e || e > o - r, l = e === r || e === o - r;
                            0 === e ? t.textAlign = "center" : e === n ? t.textAlign = "center" : n > e ? t.textAlign = "left" : t.textAlign = "right", l ? t.textBaseline = "middle" : h ? t.textBaseline = "bottom" : t.textBaseline = "top", t.fillText(this.chart.data.labels[e], s.x, s.y)
                        }
                    }
                }
            }
        });
        e.scaleService.registerScaleType("radialLinear", s, a)
        ...
        var e = this, i = e.Chart, a = i.helpers, s = {
            units: [{
                name: "millisecond",
                ...
                name: "hour",
                steps: [1, 2, 3, 6, 12]
            }, {name: "day", steps: [1, 2, 5]}, {name: "week", maxStep: 4}, {name: "month", maxStep: 3}, {
                name: "quarter",
                maxStep: 4
            }, {name: "year", maxStep: !1}]
        }, o = {
            ...
            getLabelMoment: function (t, e) {
                ...
                this.labelMoments = [];
                var e = [];
                this.chart.data.labels && this.chart.data.labels.length > 0 ? (a.each(this.chart.data.labels, function (t, i) {
                    var a = this.parseTime(t);
                    this.options.time.round && a.startOf(this.options.time.round), e.push(a)
                }, this), this.options.time.min ? this.firstTick = this.parseTime(this.options.time.min) : this.firstTick = t.min.call(this, e), this.options.time.max ? this.lastTick = this.parseTime(this.options.time.max) : this.lastTick = t.max.call(this, e)) : (this.firstTick = null, this.lastTick = null), a.each(this.chart.data.datasets, function (i, s) {
                    var o = [];
                    "object" == typeof i.data[0] ? a.each(i.data, function (e, i) {
                        var a = this.parseTime(this.getRightValue(e));
                        this.options.time.round && a.startOf(this.options.time.round), o.push(a), this.firstTick = null !== this.firstTick ? t.min(this.firstTick, a) : a, this.lastTick = null !== this.lastTick ? t.max(this.lastTick, a) : a
                    }, this) : o = e, this.labelMoments.push(o)
                }, this), this.firstTick = (this.firstTick || t()).clone(), this.lastTick = (this.lastTick || t()).clone()
            }, buildTicks: function (t) {
                if (this.ticks = [], this.unitScale = 1, this.options.time.unit)this.tickUnit = this.options.time.unit || "day", this.displayFormat = this.options.time.displayFormats[this.tickUnit], this.tickRange = Math.ceil(this.lastTick.diff(this.firstTick, this.tickUnit, !0)); else {
                    var e = this.width - (this.paddingLeft + this.paddingRight), i = e / (this.options.ticks.fontSize + 10), o = this.options.time.round ? 0 : 2;
                    this.tickUnit = "millisecond", this.tickRange = Math.ceil(this.lastTick.diff(this.firstTick, this.tickUnit, !0) + o), this.displayFormat = this.options.time.displayFormats[this.tickUnit];
                    for (var n = 0, r = s.units[n]; n < s.units.length;) {
                        if (this.unitScale = 1, a.isArray(r.steps) && Math.ceil(this.tickRange / i) < a.max(r.steps)) {
                            for (var h = 0; h < r.steps.length; ++h)if (r.steps[h] > Math.ceil(this.tickRange / i)) {
                                this.unitScale = r.steps[h];
                                break
                            }
                            break
                        }
                        ...
                        ++n, r = s.units[n], this.tickUnit = r.name, this.tickRange = Math.ceil(this.lastTick.diff(this.firstTick, this.tickUnit) + o), this.displayFormat = this.options.time.displayFormats[r.name]
                    }
                }
                this.firstTick.startOf(this.tickUnit), this.lastTick.endOf(this.tickUnit), this.smallestLabelSeparation = this.width, a.each(this.chart.data.datasets, function (t, e) {
                ...
                for (var l = 0; l <= this.tickRange; ++l)if (l % this.unitScale === 0)this.ticks.push(this.firstTick.clone().add(l, this.tickUnit)); else if (l === this.tickRange) {
                ...
                var s = this.getLabelMoment(i, e), o = s.diff(this.firstTick, this.tickUnit, !0), n = o / this.tickRange;
                if (this.isHorizontal()) {
                    var r = this.width - (this.paddingLeft + this.paddingRight), h = (r / Math.max(this.ticks.length - 1, 1), r * n + this.paddingLeft);
                    return this.left + Math.round(h)
                }
                var l = this.height - (this.paddingTop + this.paddingBottom), c = (l / Math.max(this.ticks.length - 1, 1), l * n + this.paddingTop);
        ...
        i.scaleService.registerScaleType("time", n, o)
        ...
        e.defaults.global.elements.arc = {
            ...
            inLabelRange: function (t) {
                ...
                var a = this._view;
                if (a) {
                    var s = i.getAngleFromPoint(a, {
                        x: t,
                        y: e
                    }), o = a.startAngle < -.5 * Math.PI ? a.startAngle + 2 * Math.PI : a.startAngle > 1.5 * Math.PI ? a.startAngle - 2 * Math.PI : a.startAngle, n = a.endAngle < -.5 * Math.PI ? a.endAngle + 2 * Math.PI : a.endAngle > 1.5 * Math.PI ? a.endAngle - 2 * Math.PI : a.endAngle, r = s.angle >= o && s.angle <= n, h = s.distance >= a.innerRadius && s.distance <= a.outerRadius;
                    return r && h
                }
                return !1
            }, tooltipPosition: function () {
        ...
        e.defaults.global.elements.line = {
            ...
            lineToNextPoint: function (t, e, i, a, s) {
                ...
                var a = this, s = this._view, o = this._chart.ctx, n = this._children[0], r = this._children[this._children.length - 1];
                o.save(), this._children.length > 0 && s.fill && (o.beginPath(), i.each(this._children, function (t, e) {
                    var a = i.previousItem(this._children, e), n = i.nextItem(this._children, e);
                    0 === e ? (this._loop ? o.moveTo(s.scaleZero.x, s.scaleZero.y) : o.moveTo(t._view.x, s.scaleZero), t._view.skip ? this._loop || o.moveTo(n._view.x, this._view.scaleZero) : o.lineTo(t._view.x, t._view.y)) : this.lineToNextPoint(a, t, n, function (t, e, i) {
                ...
                }, this), this._loop ? t(!0) : (o.lineTo(this._children[this._children.length - 1]._view.x, s.scaleZero), o.lineTo(this._children[0]._view.x, s.scaleZero)), o.fillStyle = s.backgroundColor || e.defaults.global.defaultColor, o.closePath(), o.fill()), o.lineCap = s.borderCapStyle || e.defaults.global.elements.line.borderCapStyle, o.setLineDash && o.setLineDash(s.borderDash || e.defaults.global.elements.line.borderDash), o.lineDashOffset = s.borderDashOffset || e.defaults.global.elements.line.borderDashOffset, o.lineJoin = s.borderJoinStyle || e.defaults.global.elements.line.borderJoinStyle, o.lineWidth = s.borderWidth || e.defaults.global.elements.line.borderWidth, o.strokeStyle = s.borderColor || e.defaults.global.defaultColor, o.beginPath(), i.each(this._children, function (t, e) {
                    var a = i.previousItem(this._children, e), s = i.nextItem(this._children, e);
                    0 === e ? o.moveTo(t._view.x, t._view.y) : this.lineToNextPoint(a, t, s, function (t, e, i) {
        ...
        e.defaults.global.elements.point = {
            ...
            inRange: function (t, e) {
                ...
                var t = this._view, i = this._chart.ctx;
                t.skip || (t.radius > 0 || t.borderWidth > 0) && (i.beginPath(), i.arc(t.x, t.y, t.radius || e.defaults.global.elements.point.radius, 0, 2 * Math.PI), i.closePath(), i.strokeStyle = t.borderColor || e.defaults.global.defaultColor, i.lineWidth = t.borderWidth || e.defaults.global.elements.point.borderWidth, i.fillStyle = t.backgroundColor || e.defaults.global.defaultColor, i.fill(), i.stroke())
            }
        })
    }.call(this), function () {
        "use strict";
        ...
        e.defaults.global.elements.rectangle = {
            ...
            draw: function () {
                var t = this._chart.ctx, e = this._view, i = e.width / 2, a = e.x - i, s = e.x + i, o = e.base - (e.base - e.y), n = e.borderWidth / 2;
                e.borderWidth && (a += n, s -= n, o += n), t.beginPath(), t.fillStyle = e.backgroundColor, t.strokeStyle = e.borderColor, t.lineWidth = e.borderWidth, t.moveTo(a, e.base), t.lineTo(a, o), t.lineTo(s, o), t.lineTo(s, e.base), t.fill(), e.borderWidth && t.stroke()
            }, height: function () {
                var t = this._view;
                return t.base - t.y
            }, inRange: function (t, e) {
        ...
        e.defaults.bubble = i, e.Bubble = function (t, i) {
        ...
        "use strict";
        var t = this, e = t.Chart, i = e.helpers, a = {aspectRatio: 1};
        e.Radar = function (t, s) {
            return s.options = i.configMerge(a, s.options), s.type = "radar", new e(t, s)
        }
    }.call(this), function () {
        "use strict";
        var t = this, e = t.Chart, i = (e.helpers, {
