...
(function (a) {
    ...
    c.prototype.init = function (b) {
        ...
        b.hooks.bindEvents.push(function (b, d) {
            ...
            if (c.plotOptions.tooltip === !1 || typeof c.plotOptions.tooltip == "undefined")return;
            ...
            a(b.getPlaceholder()).bind("plothover", function (a, b, d) {
                if (d) {
                    ...
                    }).show(), typeof c.tooltipOptions.onHover == "function" && c.tooltipOptions.onHover(d, e)
                } else e.hide().html("")
        ...
        var d;
        return b.match(a) !== null && RegExp.$1 !== "" && (d = RegExp.$1, c = c.toFixed(d), b = b.replace(a, c)), b
    };
    var d = [], e = function (a) {
        d.push(new c(a))
    };
