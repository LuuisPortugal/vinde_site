!function (t) {
    ...
    function e(e, n, a, r) {
            ...
            if (null != ni.legend.container ? t(ni.legend.container).html("") : e.find(".legend").remove(), ni.legend.show) {
                ...
                if (r && n.push("</tr>"), 0 != n.length) {
                    ...
                    if (null != ni.legend.container)t(ni.legend.container).html(f); else {
                        ...
                        null == p[0] && (p = [p, p]), "n" == d.charAt(0) ? u += "top:17px;" : "s" == d.charAt(0) && (u += "bottom:" + (p[1] + ui.bottom) + "px;"), "e" == d.charAt(1) ? u += "right:" + (p[0] + ui.right) + "px;" : "w" == d.charAt(1) && (u += "left:" + (p[0] + ui.left) + "px;");
        ...
        xi.setData = h, xi.setupGrid = W, xi.draw = P, xi.getPlaceholder = function () {
            return e
            ...
            var i = {};
            return t.each(hi.concat(fi), function (t, e) {
            ...
            return fi
        }, xi.c2p = p, xi.p2c = m, xi.getOptions = function () {
            return ni
        }, xi.highlight = $, xi.unhighlight = K, xi.triggerRedrawOverlay = U, xi.pointOffset = function (t) {
            return {
                left: parseInt(hi[u(t, "x") - 1].p2c(+t.x) + ui.left, 10),
                top: parseInt(fi[u(t, "y") - 1].p2c(+t.y) + ui.top, 10)
            }
        }, xi.shutdown = y, xi.destroy = function () {
            y(), e.removeData("plot").empty(), oi = [], ni = null, ai = null, ri = null, li = null, si = null, ci = null, hi = [], fi = [], mi = null, gi = [], xi = null
        }, xi.resize = function () {
            var t = e.width(), i = e.height();
            ai.resize(t, i), ri.resize(t, i)
        }, xi.hooks = mi, s(xi), c(a), v(), h(n), W(), P(), k();
        var gi = [], bi = null
    }
    ...
    t.fn.detach || (t.fn.detach = function () {
        ...
        f = {
            ...
            x: i,
            y: e
        }, h.push(f), f.element.css({top: Math.round(e), left: Math.round(i), "text-align": l})
